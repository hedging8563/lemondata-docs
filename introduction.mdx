---
title: "Introduction"
description: "Access 700+ AI models through a unified API"
---

## What is LemonData?

LemonData is an AI API aggregation platform that provides unified access to **700+ AI models** from leading providers including OpenAI, Anthropic, Google, DeepSeek, and more.

<CardGroup cols={2}>
  <Card title="OpenAI Compatible" icon="plug">
    Drop-in replacement for OpenAI API. Just change the base URL.
  </Card>
  <Card title="700+ Models" icon="robot">
...
<CardGroup cols={2}>
  ...
  <Card title="Models" icon="robot" href="/models/overview">
    Browse all 700+ available models.
  </Card>
