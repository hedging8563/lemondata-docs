...
description: "Obtener el estado y los resultados de una tarea de generación de música"
---

Realice peticiones (polling) a este endpoint para verificar el estado de una tarea de generación de música.

## Parámetros de ruta

<ParamField path="id" type="string" required>
  ID de la tarea de generación de música.
</ParamField>
...
<ResponseField name="audio_url" type="string">
  Enlace de descarga del archivo de audio (cuando se completa).
</ResponseField>

<ResponseField name="video_url" type="string">
  Enlace a la versión en video con efectos de visualización (cuando se completa).
</ResponseField>
...
<ResponseField name="lyrics" type="string">
  Letra generada o proporcionada.
</ResponseField>
