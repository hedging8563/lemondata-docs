...
description: "Obtener el estado y los resultados de una tarea de generación de video"
---

## Parámetros de ruta

<ParamField path="task_id" type="string" required>
  El ID de la tarea devuelto en la solicitud de creación de video.
</ParamField>
...
<ResponseField name="completed_at" type="integer">
  Marca de tiempo de finalización (cuando se completa).
</ResponseField>
...
- Implementar un retroceso exponencial (exponential backoff) para tareas de larga duración
- Establecer un tiempo de espera máximo (por ejemplo, 10 minutos)
- Manejar adecuadamente el estado `failed`
