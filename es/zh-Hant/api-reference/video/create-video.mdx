...
description: "Crear una tarea de generación de video"
---

## Resumen

La generación de video es asíncrona. Usted envía una solicitud y recibe un `task_id`, luego realiza un sondeo (polling) para obtener los resultados.

## Cuerpo de la solicitud

<ParamField body="model" type="string" default="kling-video">
  Modelo de video (por ejemplo: `kling-video`, `veo3.1`, `wan2.6-i2v`).
</ParamField>
...
<ParamField body="image_url" type="string">
  Imagen inicial opcional para la generación de imagen a video (image-to-video).
</ParamField>
...
<ParamField body="resolution" type="string">
  Resolución del video (por ejemplo: `1080p`, `720p`).
</ParamField>
...
<ParamField body="negative_prompt" type="string">
  Contenido a evitar en la generación del video.
</ParamField>

<ParamField body="seed" type="integer">
  Semilla aleatoria para generaciones reproducibles.
</ParamField>
...
<ResponseField name="task_id" type="string">
  Identificador único de la tarea para el sondeo (polling).
</ResponseField>
...
| `veo3.1` | T2V | El modelo más reciente de Google |
| `veo3.1-pro` | T2V | Calidad de nivel profesional |
| `minimax/video-01` | T2V | Alto sentido del ritmo y estabilidad |
