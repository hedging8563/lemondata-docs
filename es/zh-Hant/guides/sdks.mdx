...
description: "SDKs oficiales y de la comunidad de LemonData"
---

## Resumen

LemonData es **compatible con OpenAI**, lo que significa que solo necesita cambiar la base URL para usar cualquier SDK de OpenAI. También soportamos los SDK nativos de Anthropic y Google Gemini.

## SDKs Oficiales

Dado que LemonData es compatible con OpenAI, utilice los SDK oficiales de OpenAI:
...
Recomendamos usar variables de entorno para gestionar sus API keys:
...
Para solicitudes nativas de Anthropic, utilice el SDK de Anthropic:
...
Consulte la guía de [Integración con LangChain](/integrations/langchain) para obtener información sobre la integración del framework.