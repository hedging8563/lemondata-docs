---
title: "Streaming"
description: "Implementación de respuestas de streaming en tiempo real"
---

## Información general

El streaming le permite recibir contenido parcial en tiempo real a medida que se genera la respuesta, lo que proporciona una mejor experiencia de usuario para las aplicaciones de chat.

## Habilitar streaming

Establezca `stream: true` en su solicitud:
...
Cada fragmento (chunk) en el streaming sigue el siguiente formato:
...
## Manejo del fin del streaming

El streaming finaliza en:
- `finish_reason: "stop"` - Finalización normal
- `finish_reason: "length"` - Se alcanzó el límite de `max_tokens`
- `finish_reason: "tool_calls"` - El modelo desea llamar a herramientas
- `data: [DONE]` - El último mensaje
