---
title: "SDK de OpenAI"
description: "Utilice LemonData a través del SDK oficial de OpenAI"
---

## Descripción general

LemonData es totalmente compatible con el SDK de OpenAI. Simplemente cambie la `base URL` para acceder a más de 300 modelos.
...
## Audio - Texto a voz (Text to Speech)
...
## Audio - Transcripción (Transcription)
...
La ventaja principal de LemonData es el acceso a múltiples proveedores:
