...
1. Envía la tarea. LemonData puede aplicar una reserva o predescuento estimado para verificar el saldo y los límites de gasto de la API Key.
...
Si el dashboard no refleja la liquidación o el reembolso después de que el estado terminal sea visible, contacta con support@lemondata.cc.
