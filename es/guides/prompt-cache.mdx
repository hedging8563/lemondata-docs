...
|------|-------|--------------|------|
| **Caché de plataforma** | LemonData | Coincidencia por similitud semántica | Gratis (sin llamada a la API) |
...
- **Cache** (azul cielo): Acierto de caché semántico de plataforma - costo cero.
...
| **Costo** | Gratis (sin llamada a la API) | Tarifas con descuento |
