...
| SDK de OpenAI | [OpenAI SDK](/integrations/openai-sdk) |
| SDK de Anthropic | [Anthropic SDK](/integrations/anthropic-sdk) |
| Gemini nativo | [Gemini Native API](/api-reference/gemini/generate-content) |
| Generación de imágenes | [Image Generation](/guides/image-generation) |
| Trabajos asíncronos y sondeo | [Async Jobs & Polling](/guides/async-jobs-polling) |