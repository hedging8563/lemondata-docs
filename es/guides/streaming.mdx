...
Para nuevas integraciones de estilo OpenAI, prioriza primero **Responses streaming**. Si tu framework aún usa streaming de Chat Completions, LemonData también admite esa ruta de compatibilidad.
