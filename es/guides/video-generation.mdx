...
Cuando el modelo Seedance seleccionado puede usar la biblioteca de materiales de TokenLab, las URLs de imagen y las data URLs inline compatibles se preparan como materiales reutilizables de TokenLab antes de generar. Si la preparación tarda más de 60 segundos, reintenta cuando los `auto_material_asset_ids` devueltos estén `ACTIVE`. Si el modelo seleccionado no puede usar la biblioteca de materiales, las entradas de imagen normales siguen el flujo de imagen habitual.
