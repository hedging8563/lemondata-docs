...
Puedes ver el inventario público actual de modelos de video a través de la [Models API](/es/api-reference/models/list-models) o en la [página de modelos](https://lemondata.cc/es/models).
...
sequenceDiagram
    ...
    LemonData->>Provider: Reenvía la solicitud normalizada
    ...
    loop Consultar cada 5-10 s
        ...
        LemonData->>Provider: Consulta el estado
        Provider-->>LemonData: Actualización de estado
...
| `output_audio` | boolean | La familia Veo 3 trata la omisión como `true` |
