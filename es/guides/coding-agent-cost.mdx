...
El [caché semántico](/es/guides/caching) de LemonData empareja solicitudes por significado:
...
El [Prompt Cache upstream](/es/guides/prompt-cache) funciona automáticamente:
...
<AccordionGroup>
  ...
  <Accordion title="Cursor">
    Configuración → Modelos → Clave de API de OpenAI: `sk-your-key`, URL base: `https://api.lemondata.cc/v1`
