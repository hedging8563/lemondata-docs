...
TokenLab proporciona un sistema de caching inteligente que puede reducir significativamente sus costos de API y la latencia de respuesta. Nuestro caching va más allá de la simple coincidencia de solicitudes: entiende el **significado semántico** de sus prompts.
...
TokenLab utiliza un sistema de caching de dos capas:
...
- **Etapa 2 (Contexto completo)**: ≥95% de similitud incluyendo el contexto de la conversación
...
| Modo         | Descripción                                                       |
| ------------ | ----------------------------------------------------------------- |
| **Predeterminado**  | Cache habilitado, puede compartirse con solicitudes similares     |
