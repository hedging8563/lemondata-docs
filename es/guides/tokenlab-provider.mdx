...
Para las versiones actuales de OpenClaw, el enfoque recomendado es configurar TokenLab a través de `models.providers`.
...
<AccordionGroup>
  ...
  <Accordion title="Olvidar /v1 en lemondata-responses">
    `openai-responses` se mapea a la ruta `/v1/responses` de TokenLab, por lo que `lemondata-responses` debe usar `https://api.tokenlab.sh/v1`.
  </Accordion>
