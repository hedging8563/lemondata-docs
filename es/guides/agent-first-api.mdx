...
Cuando un modelo existe internamente pero actualmente no está expuesto para solicitudes públicas:
...
Los agentes deben tratar esto como una señal de disponibilidad de la plataforma, no como un error tipográfico. Reintenta el mismo modelo solo después de que aparezca en `GET /v1/models`.
