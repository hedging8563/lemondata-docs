...
| **Gemini CLI** | Mejor esfuerzo / experimental | Gemini | El flujo personalizado de URL base de LemonData no es un contrato estable del upstream |
...
| **LlamaIndex** | Python | Compatible mediante `OpenAILike` | Usa `OpenAILike`, no las clases OpenAI integradas, para pasarelas de terceros como LemonData |
...
<AccordionGroup>
  ...
  <Accordion title="Usa el formato tool_choice adecuado">
    Haz coincidir el formato esperado por tu SDK. LemonData acepta formatos de OpenAI y Anthropic.
  </Accordion>
</AccordionGroup>
