---
title: "✨ Skill de integración API de LemonData"
description: "Instala el skill compartido de integración API de LemonData para cualquier agente de código, con recuperación de errores Agent-First."
---

<Note>
Este skill le enseña a tu agente de código a integrar las **300+ API de IA** de LemonData simplemente describiendo lo que necesitas. Está empaquetado como un skill agent-first compartido y funciona con cualquier agente de código que admita archivos skill o rules.

Esta API es **[Agent-First](/guides/agent-first-api)** — incluso si el agente adivina mal el nombre del modelo, la respuesta de error le indica exactamente cómo corregirlo.
</Note>
...
Si tu herramienta no admite el instalador, copia la carpeta `skills/lemondata-api-integration/` del repositorio al directorio compartido de skills o rules de tu herramienta.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="¿Qué agentes de codificación son compatibles?">
    Funciona con cualquier agente de código que admita directorios compartidos de skills o rules. Si la herramienta admite el instalador, `npx skills add` colocará automáticamente el skill compartido `lemondata-api-integration` en la ubicación detectada.
  </Accordion>
...
<Info>
**¿Tienes preguntas?** Consulta nuestros [GitHub Issues](https://github.com/hedging8563/lemondata-skills/issues) o contacta con [support@lemondata.cc](mailto:support@lemondata.cc)
</Info>