...
<AccordionGroup>
  ...
  <Accordion title="¿Qué agentes de codificación son compatibles?">
    Cualquier herramienta que admita archivos de skill/rules: Claude Code, Cursor, GitHub Copilot, Windsurf y más. El instalador `npx skills add` detecta e instala automáticamente en todas las herramientas compatibles.
  </Accordion>
