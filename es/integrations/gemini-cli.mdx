...
Google Gemini CLI es una herramienta de línea de comandos para interactuar con los modelos de Gemini. LemonData proporciona un punto de conexión compatible que te permite usar Gemini CLI con acceso a más de 300 modelos.
