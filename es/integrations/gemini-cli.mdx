...
Google Gemini CLI es una herramienta de línea de comandos para interactuar con los modelos de Gemini. LemonData proporciona un punto de conexión compatible que te permite usar Gemini CLI con acceso a cientos de modelos.


<Warning>
Esta integración debe tratarse como experimental: Gemini CLI no documenta actualmente un flujo estable con una URL base personalizada al estilo LemonData. Si necesita una integración de LemonData realmente compatible, prefiera Codex CLI, Claude Code u OpenCode.
</Warning>
