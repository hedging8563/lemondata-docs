...
Para la mayoría de proyectos nuevos, prefiera **Chat Completions** como la ruta OpenAI-compatible predeterminada. Use **Responses API** solo cuando necesite explícitamente el comportamiento específico de Responses.
...
**Ruta primaria**: OpenAI-compatible / Chat Completions
...
Chat Completions es la ruta OpenAI-compatible predeterminada para LemonData:
...
<AccordionGroup>
  <Accordion title="Error de conexión">
    - Verifique que la URL base sea exactamente `https://api.lemondata.cc/v1`
  ...
  <Accordion title="Autenticación fallida">
    ...
    - Confirme que la clave esté activa en el panel de LemonData
