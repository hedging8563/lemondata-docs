...
<CardGroup cols={2}>
  <Card title="Instalar en Cursor" icon="arrow-pointer" href="https://cursor.com/en/install-mcp?name=tokenlab-model-catalog&config=eyJ0eXBlIjoic3RkaW8iLCJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkB0b2tlbmxhYmFpL21jcC1zZXJ2ZXIiXSwiZW52Ijp7IlRPS0VOTEFCX01DUF9UT09MX1BST0ZJTEUiOiJjYXRhbG9nIn19">
    Añade el perfil público `catalog` a Cursor con un clic
  </Card>
  <Card title="Instalar en VS Code" icon="code" href="https://vscode.dev/redirect/mcp/install?name=tokenlab-model-catalog&config=%7B%22type%22%3A%22stdio%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22%40tokenlabai%2Fmcp-server%22%5D%2C%22env%22%3A%7B%22TOKENLAB_MCP_TOOL_PROFILE%22%3A%22catalog%22%7D%7D">
...
En cualquier cliente stdio local usa el nombre `tokenlab-model-catalog`, el comando `npx`, los argumentos separados `-y` y `@tokenlabai/mcp-server`, y deja vacío el directorio de trabajo. Usa `@tokenlabai/mcp-server@0.6.17` para fijar la versión verificada actualmente.
