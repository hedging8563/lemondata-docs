...
| Argumentos | `-y` y después `@tokenlabai/mcp-server` | Usa `@tokenlabai/mcp-server@0.6.10` para fijar la versión verificada actualmente. |
...
<CardGroup cols={2}>
  <Card title="TokenLab MCP" icon="plug" href="https://tokenlab.sh/mcp">
    Descripción del producto y opciones de conexión para los conjuntos Core 31 y Full 77
  </Card>
