---
title: "Claude Code"
description: "Usa LemonData con la CLI Claude Code de Anthropic"
---
...
[Claude Code](https://docs.anthropic.com/en/docs/claude-code) es la herramienta CLI oficial de Anthropic para programación asistida por AI. Puedes configurarla para usar LemonData como proveedor de API.
...
<Note>
Para LemonData, mantén `ANTHROPIC_BASE_URL` en `https://api.tokenlab.sh` sin el sufijo `/v1`. Esto coincide con la forma del endpoint de estilo Anthropic y el patrón de gateway unificado documentado por Claude Code.
</Note>
