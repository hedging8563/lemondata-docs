...
Anthropic ahora recomienda el instalador nativo. La instalación con npm sigue disponible por compatibilidad, pero está obsoleta aguas arriba.

```bash
curl -fsSL https://claude.ai/install.sh | bash
```

Si necesita específicamente el paquete npm, use:
...
<Warning>
No use `sudo npm install -g` para Claude Code.
</Warning>
