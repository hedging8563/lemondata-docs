...
Para LemonData, la ruta por defecto más limpia es usar el modo **OpenAI personalizado / compatible con OpenAI** de LiteLLM con `api_base = https://api.tokenlab.sh/v1`.
