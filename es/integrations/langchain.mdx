...
<Note>
Para nuevos proyectos agentic, LangChain recomienda considerar LangGraph para un control más explícito sobre flujos de trabajo de larga duración y que usan herramientas.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Usa modelos más económicos para retrieval">
