---
title: "OpenCode"
description: "Configura OpenCode para usar la API de LemonData"
---

## Descripción general

OpenCode es un asistente de programación con AI de código abierto que se ejecuta en tu terminal. Es compatible con múltiples proveedores de LLM y se puede configurar para usar la API de LemonData para acceder a cientos de modelos.
