...
<Note>
Use `@ai-sdk/openai-compatible` para compatibilidad estilo chat-completions. Si necesita específicamente `/v1/responses`, cambie el paquete del proveedor a `@ai-sdk/openai`.
</Note>
...
<AccordionGroup>
  <Accordion title="Error de conexión">
    - Verifique que `options.baseURL` esté configurado en `https://api.lemondata.cc/v1`
