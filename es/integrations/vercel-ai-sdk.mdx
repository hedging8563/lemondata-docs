...
Para LemonData, la opción predeterminada más estable en Vercel AI SDK es el **proveedor compatible con OpenAI**.

Si específicamente necesitas el comportamiento **nativo de Responses**, puedes cambiar al proveedor OpenAI y mantener la misma base URL de LemonData.
...
<AccordionGroup>
  <Accordion title="Prioriza openai-compatible primero">
    Para gateways de terceros y backends proxy, `@ai-sdk/openai-compatible` suele ser el punto de partida que genera menos sorpresas.
  </Accordion>
  ...
  <Accordion title="Mantén los secretos en el servidor">
    Nunca expongas tu API key de LemonData en código del lado del cliente. Coloca la configuración del proveedor en archivos del servidor o rutas de API.
  </Accordion>
</AccordionGroup>