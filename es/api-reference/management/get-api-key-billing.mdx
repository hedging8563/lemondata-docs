...
Este endpoint devuelve agregados de facturación basados en consumo para la clave API seleccionada, incluyendo coste total, solicitudes totales, uso por unidad de facturación y desgloses por nombre de modelo solicitado (`model`), proveedor, `scene`, ``, clase de caché y tendencia diaria de coste.
