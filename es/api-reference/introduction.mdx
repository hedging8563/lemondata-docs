...
<Warning>
**Sobre el Playground interactivo**: El playground en este sitio de documentación es solo para fines de demostración y no admite la entrada de claves API. Para probar la API, utiliza:
...
Soporte nativo del formato de API de Google Gemini:
...
<Note>
Los endpoints de Gemini admiten autenticación mediante parámetro de consulta `?key=` además del token Bearer estándar.
</Note>
