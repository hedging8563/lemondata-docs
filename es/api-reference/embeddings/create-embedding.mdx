...
<ParamField body="input" type="string | array" required>
  Texto de entrada para generar el embedding. Puede ser una cadena o un arreglo de cadenas.
</ParamField>
...
<ResponseField name="data" type="array">
  Arreglo de objetos de embedding.

  Cada objeto contiene:
  - `object` (string): `embedding`
  - `index` (integer): Índice en el arreglo de entrada
