...
<ParamField body="model" type="string" required>
  ID del modelo a usar. Vea [Modelos](https://lemondata.cc/es/models) para las opciones disponibles.
</ParamField>
...
<ParamField body="tools" type="array">
  ...
  Para herramientas alojadas `image_generation` que usan el modelo de herramienta de imagen predeterminado o establecen explícitamente `model: "gpt-image-2"`, LemonData elimina `input_fidelity` antes de reenviar la solicitud porque GPT Image 2 ya trata las entradas de imagen con alta fidelidad. No envíes `background: "transparent"` para esta herramienta; LemonData no lo elimina silenciosamente porque eso cambia la semántica de salida.
</ParamField>
