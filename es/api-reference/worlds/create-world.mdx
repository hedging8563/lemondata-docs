...
Este endpoint cubre generación de mundos y polling. TokenLab no proxifica actualmente la carga de media assets de World Labs, el listado de mundos, la eliminación de mundos ni herramientas pano independientes.
