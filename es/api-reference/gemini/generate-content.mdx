...
<ParamField path="model" type="string" required>
  ...
  LemonData enrutará los canales nativos de Gemini compatibles a través de la ruta nativa cuando sea posible y hará automáticamente una degradación a la ruta interna de conversión compatible cuando una ruta lista para uso nativo no esté disponible para esa solicitud multimodal.
