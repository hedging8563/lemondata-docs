...
<ParamField body="contents" type="array" required>
  ...
  Para las partes multimedia, TokenLab acepta actualmente tipos MIME de imagen, audio y video, y los reenvía a través dlos detalhes do modelo compatible con Gemini.
