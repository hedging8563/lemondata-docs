...
Nota de compatibilidad: si se envía `input_fidelity` con `gpt-image-2`, TokenLab lo elimina porque GPT Image 2 ya procesa las entradas de imagen con alta fidelidad.
</Note>
