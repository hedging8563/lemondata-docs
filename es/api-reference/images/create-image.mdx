...
<ParamField body="resolution" type="string">
  ...
  Se admite en `gemini-3-pro-image-preview`, `nano-banana-pro`, `nano-banana-2` y familias de alta resolución similares. Los valores típicos son `1k`, `2k` y `4k`. No envíes este parámetro a las familias de imágenes Flash de Gemini salvo que el modelo lo documente explícitamente. Para los modelos de imagen xAI Grok Imagine, usa `1k` o `2k`.
</ParamField>
