...
<Note>
`gpt-image-2` es un modelo GPT Image con facturación por tokens. LemonData sigue el desglose oficial de `usage` de OpenAI para liquidar tokens de entrada de texto, entrada de imagen, entrada en caché cuando se reporta, y salida de imagen; no se factura como un precio fijo por imagen.
</Note>
