...
<ParamField body="size" type="string" default="1024x1024">
  ...
  Para `gpt-image-2`, `size` se reenvía a la ruta upstream compatible con OpenAI y puede usar cualquier valor válido que el modelo acepte actualmente. `aspect_ratio` y `resolution` no forman parte del contrato público actual de LemonData para `gpt-image-2`.
