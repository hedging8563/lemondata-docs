---
title: "自託管安裝"
description: "在您自己的伺服器上執行 LemonClaw，接入 LemonData AI API — 一條指令，無需 Docker"
---

<Note>
**自託管**代表您直接在自己的 VPS 或機器上執行 LemonClaw。您只需透過 LemonData 餘額支付 AI 模型使用費用 — 無實例費用。
</Note>
...
可用的模型前綴（取決於你在 [LemonData Provider 設定](/claw/lemondata-provider) 中啟用了哪些 provider）：
...
<Info>
**原始碼**：[github.com/hedging8563/lemonclaw](https://github.com/hedging8563/lemonclaw)
</Info>
