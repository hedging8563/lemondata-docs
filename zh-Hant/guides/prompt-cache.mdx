...
除了 TokenLab 的 [平台語義快取](/guides/caching) 之外，許多 AI 供應商也提供自有的 **Prompt 快取** 功能。這是一種運作於供應商層級（Anthropic、OpenAI、DeepSeek 等）的獨立快取機制。
...
| 類型 | 位置 | 運作方式 | 成本 |
|------|-------|--------------|------|
| **平台快取** | TokenLab | 語義相似度比對 | 正常價格的 10% |
...
<Info>
折扣會自動套用。TokenLab 會將供應商的快取定價直接轉嫁給您。
</Info>
