...
|------|-------------|-------------|
| **User** | 60 | 所有帳戶的預設層級 |
| **Partner** | 300 | 適用於整合合作夥伴 |
| **VIP** | 1,000 | 高用量使用者 |

<Note>
  速率限制可能會有所變動。如需自定義限制，請聯繫 support@lemondata.cc。
</Note>
...
```
X-RateLimit-Limit: 60          # 您每分鐘的限制
X-RateLimit-Remaining: 55      # 剩餘請求數
X-RateLimit-Reset: 1234567890  # 限制重置的 Unix 時間戳記
```
...
1. 登入您的 [Dashboard](https://lemondata.cc/dashboard)
