...
OpenCode 是一款在终端运行的开源 AI 编程助手。它支持多个 LLM 提供商，并可配置使用 LemonData 的 API 来访问 300 多个模型。
...
<AccordionGroup>
  ...
  <Accordion title="未找到模型">
    - 检查配置中的模型名称是否完全匹配
    - 在 [lemondata.cc/en/models](https://lemondata.cc/zh-Hant/models) 验证模型可用性
  </Accordion>
</AccordionGroup>
