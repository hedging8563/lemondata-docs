...
description: "為任何程式設計代理工具安裝共用的 LemonData API 整合技能，具備 Agent-First 錯誤恢復能力。"
---

<Note>
此技能會教你的程式設計代理工具只需描述你的需求，即可整合 LemonData 的 **數百個 AI API**。它被封裝為一個共用的 agent-first 技能，並可搭配任何支援技能或規則檔案的程式設計代理工具使用。
...
<CardGroup cols={2}>
  ...
  <Card title="Models" icon="sparkles" href="https://lemondata.cc/zh-TW/models">
    瀏覽數百個可用模型
  </Card>
