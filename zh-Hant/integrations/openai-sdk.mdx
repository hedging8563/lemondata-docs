---
title: "OpenAI SDK"
description: "在官方 OpenAI SDK 及相容客戶端中使用 LemonData"
---

## 概覽

LemonData 可與官方 OpenAI SDK 一起使用，方法是將客戶端指向 `https://api.lemondata.cc/v1`。
...
**主要路徑**: OpenAI-compatible / Chat Completions

**支援信心**: Supported core path
</Note>
