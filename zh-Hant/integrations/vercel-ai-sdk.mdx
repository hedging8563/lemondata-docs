---
title: "Vercel AI SDK"
description: "使用 OpenAI 相容或 Responses 原生供應商將 LemonData 整合到 Vercel AI SDK"
---
...
對於 LemonData，Vercel AI SDK 中最穩定的預設選項是 **OpenAI 相容供應商**。

如果你明確需要 **Responses 原生** 行為，可以切換到 OpenAI 供應商，並保持相同的 LemonData base URL。
