...
| **Partner** | 3,000 | Para parceiros de integração |
...
<AccordionGroup>
  ...
  <Accordion title="Entre em contato conosco para limites mais altos">
    Se você precisar de limites mais altos, entre em contato com support@lemondata.cc.
  </Accordion>
</AccordionGroup>
...
1. Faça login no seu [Dashboard](https://lemondata.cc/dashboard)
2. Vá para **Settings → Account**
3. Entre em contato com o suporte com seu caso de uso

Ou envie um email para support@lemondata.cc com:
