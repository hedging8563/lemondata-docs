...
Para novas integrações no estilo OpenAI, prefira primeiro **Responses streaming**. Se o seu framework ainda usa streaming de Chat Completions, a TokenLab também oferece suporte a esse caminho de compatibilidade.
