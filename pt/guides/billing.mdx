...
<Note>
  Os preços exibidos são preços com desconto da plataforma. Os preços reais podem variar. Verifique a [página de preços](https://tokenlab.sh/pt/pricing) para as taxas atuais.
</Note>
