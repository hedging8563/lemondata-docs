...
1. Envie a tarefa. A LemonData pode aplicar uma pré-dedução ou reserva estimada para verificar saldo e limites de gasto da API Key.
...
Se o dashboard não refletir a liquidação ou o reembolso depois que o estado terminal estiver visível, entre em contato com support@lemondata.cc.
