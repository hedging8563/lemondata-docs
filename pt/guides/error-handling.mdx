...
| Tipo | Código | Descrição |
|------|------|-------------|
| `insufficient_balance` | `insufficient_balance` | O saldo da conta é insuficiente (endpoints compatíveis com OpenAI) |
| `insufficient_balance_error` | `insufficient_balance` | O saldo da conta é insuficiente (endpoints compatíveis com Anthropic) |
