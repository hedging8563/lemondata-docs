...
|------|-------|--------------|------|
| **Cache da Plataforma** | LemonData | Correspondência por similaridade semântica | 20% do preço normal |
...
|----------|---------------------|------------------|------------|
| **Anthropic** | 90% de desconto | Igual à entrada | 1024 |
...
- **Cache** (azul céu): Hit de cache semântico da plataforma - desconto de 80%
...
| **Custo** | 20% do preço normal | Taxas com desconto |
