...
Além do [cache semântico da plataforma](/guides/caching) da TokenLab, muitos provedores de IA oferecem seu próprio recurso de **cache de prompt**. Este é um mecanismo de cache separado que opera no nível do provedor (Anthropic, OpenAI, DeepSeek, etc.).
