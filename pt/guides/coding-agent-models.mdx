...
## Como Funciona o Roteamento do TokenLab

O TokenLab roteia suas requisições para o melhor provedor disponível automaticamente.
...
Se um provedor estiver indisponível ou retornar um erro, o TokenLab tenta automaticamente com o próximo provedor:
...
Quando o modelo selecionado e o canal roteado oferecerem suporte, o TokenLab pode rotear solicitações pelo formato nativo de API da família do modelo para obter melhor compatibilidade:
