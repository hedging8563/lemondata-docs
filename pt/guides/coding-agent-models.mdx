...
Quando o modelo selecionado e o canal roteado oferecerem suporte, o LemonData pode rotear solicitações pelo formato nativo de API da família do modelo para obter melhor compatibilidade:

| Família do modelo | Formato da API | URL base |
|-------------|------------|----------|
| Claude | Anthropic Messages | `https://api.lemondata.cc` |
| GPT | Respostas da OpenAI | `https://api.lemondata.cc/v1` |
| Gemini | Gemini Native API | `https://api.lemondata.cc` ou `https://api.lemondata.cc/v1beta` dependendo do caminho do cliente |
| DeepSeek | Chat da OpenAI | `https://api.lemondata.cc/v1` |
