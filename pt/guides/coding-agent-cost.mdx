...
O [cache semântico](/guides/caching) do TokenLab corresponde requisições por significado, não por texto exato. Isso é poderoso para agentes de código porque:
...
O [cache de prompt upstream](/guides/prompt-cache) é automático pelo TokenLab. Prompts de sistema longos — que agentes de código sempre incluem — são armazenados em cache no nível do provedor:
