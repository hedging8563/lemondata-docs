...
No Seedance 2.0, URLs de imagem e data URLs inline compatíveis são preparadas automaticamente como materiais reutilizáveis da TokenLab antes da geração. Se a preparação levar mais de 60 segundos, tente novamente quando os `auto_material_asset_ids` retornados estiverem `ACTIVE`.
