...
| SDK Anthropic | [Anthropic SDK](/integrations/anthropic-sdk) |
| Gemini Nativo | [Gemini Native API](/api-reference/gemini/generate-content) |
| Geração de Imagem | [Image Generation](/guides/image-generation) |
| Trabalhos Assíncronos & Polling | [Async Jobs & Polling](/guides/async-jobs-polling) |