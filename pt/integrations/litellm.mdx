---
title: "LiteLLM"
description: "Use o LiteLLM com LemonData como fornecedor amontante ou como camada interna de passagem"
---
...
Para o LemonData, o caminho padrão mais limpo é usar o modo **OpenAI personalizado / compatível com OpenAI** do LiteLLM com `api_base = https://api.tokenlab.sh/v1`.
