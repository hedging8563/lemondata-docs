...
<Note>
Este skill ensina seu agente de programação a integrar as **centenas de APIs de IA** da LemonData apenas descrevendo o que você precisa. Ele é empacotado como um skill compartilhado agent-first e funciona com qualquer agente de programação que suporte arquivos de skill ou regras.
