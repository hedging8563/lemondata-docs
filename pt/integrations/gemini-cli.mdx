...
O Google Gemini CLI é uma ferramenta de linha de comando para interagir com os modelos Gemini. A LemonData fornece um ponto de terminação compatível que permite usar o Gemini CLI com acesso a mais de 300 modelos.
