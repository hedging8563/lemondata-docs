---
title: "Vercel AI SDK"
description: "Integre o LemonData com o Vercel AI SDK usando fornecedores compatíveis com OpenAI ou nativos do Responses"
---
...
Para o LemonData, o padrão mais estável no Vercel AI SDK é o **fornecedor compatível com OpenAI**.

Se você precisar especificamente do comportamento **nativo do Responses**, pode mudar para o fornecedor OpenAI e manter a mesma URL de base do LemonData.
