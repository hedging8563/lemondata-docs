---
title: "Vercel AI SDK"
description: "Integre o TokenLab com o Vercel AI SDK usando fornecedores compatíveis com OpenAI ou nativos do Responses"
---
...
Para o TokenLab, o padrão mais estável no Vercel AI SDK é o **fornecedor compatível com OpenAI**.

Se você precisar especificamente do comportamento **nativo do Responses**, pode mudar para o fornecedor OpenAI e manter a mesma URL de base do TokenLab.
...
<AccordionGroup>
  ...
  <Accordion title="Mantenha os segredos no servidor">
    Nunca exponha sua chave de API do TokenLab em código do lado do client. Coloque a configuração do fornecedor em arquivos de servidor ou rotas de API.
  </Accordion>
</AccordionGroup>
