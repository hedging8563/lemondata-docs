...
|---------|---------|-------------|
| **Group Policy** | Open (padrão) / Allowlist / Disabled | Controla em quais canais o bot responde |
| **Require @mention** | On / Off | O bot só responde quando @mencionado |
| **Group IDs** | Lista de IDs de canal | Restringir a canais específicos (vazio = todos os canais) |
| **Group Allowed Users** | Lista de IDs de usuário | Apenas estes usuários podem acionar o bot (modo allowlist) |

<Tip>
Por padrão, o Slack usa a política de grupo **open** — o bot responde em todos os canais para os quais é convidado. Use **allowlist** para restringir a canais específicos.
</Tip>
