...
Por padrão, o Claw usa a política de **emparelhamento** para o Slack — os usuários devem completar um emparelhamento único antes de poderem interagir com o bot. Isso impede que membros não autorizados do workspace usem seus créditos de IA.

<Tip>
A política de emparelhamento é configurada automaticamente quando você salva suas configurações do Slack. Nenhuma configuração adicional é necessária.
</Tip>
