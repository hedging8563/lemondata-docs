...
Configure o comportamento do chat em grupo nas configurações **Channels** da sua LemonClaw WebUI:
...
<Note>
O suporte atual de DingTalk no LemonClaw ainda não é uma integração completa de workbench em grupo. Mensagens de grupo só entram no fluxo de IA quando @mencionam o bot, e as respostas preferem o sessionWebhook original.
</Note>
