...
<Note>
O DingTalk **sempre requer @menção** para acionar o bot em grupos — esta é uma limitação da plataforma e não pode ser configurada. A filtragem por Group IDs não está disponível para o DingTalk; use a configuração de Group Policy para controlar o acesso.
</Note>
