---
title: "OpenAI SDK"
description: "Use o LemonData através do SDK oficial da OpenAI"
---

## Visão Geral

O LemonData é totalmente compatível com o SDK da OpenAI. Basta alterar a `base URL` para acessar mais de 300 modelos.
...
Funciona exatamente da mesma forma que a API da OpenAI:

```python
response = client.chat.completions.create(
    model="gpt-4o",  # Ou qualquer modelo do LemonData
    messages=[
...
```python
response = client.chat.completions.create(
    model="gpt-4o",  # Ou claude-sonnet-4-5
    messages=[{
        "role": "user",
        "content": [
...
## Áudio - Texto para Fala (Text to Speech)
...
## Áudio - Transcrição (Transcription)
