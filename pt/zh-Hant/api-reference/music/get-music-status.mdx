...
description: "Obtenha o status e os resultados de uma tarefa de geração de música"
---

Faça o polling deste endpoint para verificar o status de uma tarefa de geração de música.

## Parâmetros de Caminho

<ParamField path="id" type="string" required>
  ID da tarefa de geração de música.
</ParamField>
...
<ResponseField name="audio_url" type="string">
  Link para download do arquivo de áudio (quando concluído).
</ResponseField>

<ResponseField name="video_url" type="string">
  Link para a versão em vídeo com efeitos visuais (quando concluído).
</ResponseField>
