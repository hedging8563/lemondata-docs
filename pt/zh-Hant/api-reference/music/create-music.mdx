...
description: "Crie tarefas de geração de música usando Suno"
---
...
<ParamField body="model" type="string" default="suno_music">
  O modelo a ser usado: `suno_music` para geração de música, `suno_lyrics` apenas para letras.
</ParamField>

<ParamField body="prompt" type="string" required>
  Descrição da música a ser gerada. Pode incluir estilo, humor, instrumentos, etc.
</ParamField>
...
<ParamField body="continue_clip_id" type="string">
  ID do clipe anterior para continuar.
</ParamField>

<ParamField body="continue_at" type="number">
  Timestamp para continuar (em segundos).
</ParamField>
...
<ResponseField name="id" type="string">
  ID da tarefa usado para consultar o status.
</ResponseField>
