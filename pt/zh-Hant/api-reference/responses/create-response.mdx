...
description: "Crie uma resposta usando o formato da OpenAI Responses API"
---

A Responses API é a nova API de conversação com estado da OpenAI. A LemonData oferece suporte a este formato para modelos compatíveis.
...
<ParamField body="input" type="array" required>
  ...
  Cada item pode ser:
  - `message`: Uma mensagem de conversa contendo a função (role) e o conteúdo
  - `function_call`: Uma solicitação de chamada de função
  - `function_call_output`: A saída de uma chamada de função
</ParamField>

<ParamField body="instructions" type="string">
  Instruções de sistema para o modelo (equivalente a uma mensagem de sistema).
</ParamField>
...
<ParamField body="stream" type="boolean" default="false">
  Se for true, retorna um fluxo de eventos (stream).
</ParamField>

<ParamField body="previous_response_id" type="string">
  O ID da resposta anterior, usado para continuar a conversa.
</ParamField>
...
<ParamField body="metadata" type="object">
  Metadados anexados à resposta para fins de rastreamento.
</ParamField>
...
<ParamField body="parallel_tool_calls" type="boolean" default="true">
  Se permite múltiplas chamadas de ferramentas simultâneas.
</ParamField>
...
<ResponseField name="id" type="string">
  O identificador único da resposta.
</ResponseField>

<ResponseField name="object" type="string">
  Fixado como `response`.
</ResponseField>

<ResponseField name="created_at" type="integer">
  O timestamp Unix de quando a resposta foi criada.
</ResponseField>

<ResponseField name="output" type="array">
  Uma lista de itens de saída gerados pelo modelo.
</ResponseField>
