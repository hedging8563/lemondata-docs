...
description: "Obtenha o status e os resultados de uma tarefa de geração 3D"
---

Faça o polling deste endpoint para verificar o status da sua tarefa de geração de modelo 3D.

## Parâmetros de caminho

<ParamField path="id" type="string" required>
  ID da tarefa de geração 3D.
</ParamField>
