...
description: "SDKs oficiais e da comunidade da LemonData"
---

## Visão Geral

A LemonData é **compatível com a OpenAI**, o que significa que você só precisa alterar a base URL para usar qualquer SDK da OpenAI. Também oferecemos suporte aos SDKs nativos da Anthropic e do Google Gemini.

## SDKs Oficiais

Como a LemonData é compatível com a OpenAI, utilize os SDKs oficiais da OpenAI:
...
response = client.chat.completions.create(
    model="gpt-4o",  # Ou claude-sonnet-4-5, gemini-2.5-flash, etc.
...
Recomendamos o uso de variáveis de ambiente para gerenciar suas chaves de API:

```bash
# Arquivo .env ou configuração do shell
...
Para requisições nativas da Anthropic, utilize o SDK da Anthropic:
...
Consulte o guia de [Integração com LangChain](/integrations/langchain) para saber mais sobre a integração com o framework.