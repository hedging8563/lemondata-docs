...
Este endpoint faz parte da API de Lote compatível com OpenAI da LemonData. Trabalhos de lote utilizam arquivos JSONL carregados, são executados de forma assíncrona e podem retornar arquivos de saída/erro posteriormente.
