...
Se a tarefa não existir mais ou não puder mais ser resolvida através do contrato público async-task, TokenLab retorna `async_task_not_found` com a mensagem `Task not found or no longer available.`
</Info>
