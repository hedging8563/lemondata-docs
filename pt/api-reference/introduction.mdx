...
<Warning>
**Sobre o Playground interativo**: O playground neste site de documentação é apenas para fins de demonstração e não suporta a entrada de chaves de API. Para testar a API, utilize:
...
- **SDK** - Use o SDK OpenAI/Anthropic com nossa URL base
</Warning>
...
<Note>
Os endpoints Gemini suportam autenticação por parâmetro de consulta `?key=` além do token Bearer padrão.
</Note>
