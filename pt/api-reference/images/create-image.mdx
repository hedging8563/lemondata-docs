...
<Note>
`gpt-image-2` é um modelo GPT Image com cobrança por token. A LemonData segue o detalhamento oficial de `usage` da OpenAI para liquidar tokens de entrada de texto, entrada de imagem, entrada em cache quando informada, e saída de imagem; ele não é cobrado como preço fixo por imagem.
</Note>
