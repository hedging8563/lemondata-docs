...
Exemplo Nano Banana com imagem de referência: envie a solicitação para `/v1/images/generations`, não para `/v1/images/edits`, e omita `resolution`:
