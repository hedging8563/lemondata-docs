...
<ParamField body="model" type="string" required>
  Modelo a usar (por exemplo, `gpt-image-2`, `flux-pro`, `qwen-image` ou `nano-banana-pro`). Consulte `GET /v1/models?recommended_for=image` para a lista recomendada atual.
</ParamField>
...
| `qwen-image` | Frequentemente baseado em tarefa | Bom render de texto e aderência ao prompt |
