...
<ParamField body="size" type="string" default="1024x1024">
  ...
  Para `gpt-image-2`, `size` é encaminhado para a rota upstream compatível com OpenAI e pode usar qualquer valor válido atualmente aceito pelo modelo. `aspect_ratio` e `resolution` não fazem parte do contrato público atual da LemonData para `gpt-image-2`.
