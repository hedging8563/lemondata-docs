...
<Warning>
Este endpoint documenta atualmente o fluxo de edição multipart no estilo DALL-E. Outras famílias de image-to-image suportadas na LemonData usam `POST /v1/images/generations` com `operation: "image-to-image"` e entradas JSON como `image_url`, onde suportado.
</Warning>
...
<ParamField body="model" type="string" default="dall-e-2">
  O modelo a usar para edição de imagem. Atualmente apenas `dall-e-2` é suportado.
</ParamField>
...
<ParamField body="size" type="string">
  O tamanho das imagens geradas. Deve ser um de `256x256`, `512x512` ou `1024x1024`.
</ParamField>
