...
Nota de compatibilidade: se `input_fidelity` for enviado com `gpt-image-2`, a TokenLab o remove porque o GPT Image 2 já processa entradas de imagem em alta fidelidade.
</Note>
