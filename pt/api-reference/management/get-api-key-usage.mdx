...
- Todos os campos monetários continuam disponíveis em USD e agora também incluem equivalentes de exibição em RMB, como `cost_cny`, `total_cost_cny` e `cost_cny` em cada breakdown.
