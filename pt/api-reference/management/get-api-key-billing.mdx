...
Este endpoint retorna agregados de faturamento baseados em consumo para a chave API selecionada, incluindo custo total, total de requisições, uso por unidade de faturamento e detalhamentos por nome do modelo solicitado (`model`), provedor, `scene`, ``, classe de cache e tendência diária de custo.
