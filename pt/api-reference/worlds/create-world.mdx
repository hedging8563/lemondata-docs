...
Este endpoint cobre geração de mundos e polling. O TokenLab atualmente não faz proxy de upload de media assets da World Labs, listagem de mundos, exclusão de mundos ou ferramentas pano independentes.
