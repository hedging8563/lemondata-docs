...
<ResponseField name="data" type="array">
  ...
  - `tokenlab.request_format_summary` (object or `null`): Resumo leve de descoberta não chat com `public_operations`, `request_endpoint` e `request_endpoint_by_operation`
