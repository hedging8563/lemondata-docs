...
<ParamField body="tools" type="array">
  ...
  Para ferramentas hospedadas `image_generation` que usam o modelo de ferramenta de imagem padrão ou definem explicitamente `model: "gpt-image-2"`, a LemonData remove `input_fidelity` antes de encaminhar a solicitação, porque o GPT Image 2 já trata entradas de imagem como alta fidelidade. Não envie `background: "transparent"` para esta ferramenta; a LemonData não o remove silenciosamente porque isso altera a semântica de saída.
</ParamField>
