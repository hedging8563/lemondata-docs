---
title: "LlamaIndex"
description: "دمج TokenLab مع LlamaIndex باستخدام تكاملات متوافقة مع OpenAI"
---
...
بالنسبة إلى TokenLab، فإن إعداد LlamaIndex الأكثر متانة هو استخدام **تكاملات متوافقة مع OpenAI** بدلًا من فئات OpenAI المدمجة.
...
بمعنى آخر: تعامل هنا مع `OpenAILike` باعتباره المسار المدعوم لـ TokenLab، وليس فئات OpenAI المدمجة.
...
<AccordionGroup>
  <Accordion title="استخدم OpenAILike مع TokenLab">
    يُفضَّل استخدام `llama_index.llms.openai_like.OpenAILike` و `llama_index.embeddings.openai_like.OpenAILikeEmbedding` مع TokenLab وبوابات متوافق مع OpenAI الأخرى التابعة لجهات خارجية.
  </Accordion>
