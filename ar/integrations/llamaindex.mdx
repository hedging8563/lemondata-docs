...
**المسار الرئيسي**: متوافق مع OpenAI via OpenAILike
...
<AccordionGroup>
  <Accordion title="استخدم OpenAILike مع LemonData">
    يُفضَّل استخدام `llama_index.llms.openai_like.OpenAILike` و `llama_index.embeddings.openai_like.OpenAILikeEmbedding` مع LemonData وبوابات متوافق مع OpenAI الأخرى التابعة لجهات خارجية.
  </Accordion>
