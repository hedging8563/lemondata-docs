...
**المسار الرئيسي**: OpenAI-compatible via OpenAILike

**مستوى الدعم**: مدعوم عبر OpenAILike
</Note>

بالنسبة إلى LemonData، فإن إعداد LlamaIndex الأكثر متانة هو استخدام **تكاملات متوافقة مع OpenAI** بدلًا من فئات OpenAI المدمجة.
...
بمعنى آخر: تعامل هنا مع `OpenAILike` باعتباره المسار المدعوم لـ LemonData، وليس فئات OpenAI المدمجة.
...
<AccordionGroup>
  <Accordion title="استخدم OpenAILike مع LemonData">
    يُفضَّل استخدام `llama_index.llms.openai_like.OpenAILike` و `llama_index.embeddings.openai_like.OpenAILikeEmbedding` مع LemonData وبوابات OpenAI-compatible الأخرى التابعة لجهات خارجية.
  </Accordion>
