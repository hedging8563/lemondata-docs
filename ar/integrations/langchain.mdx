---
title: "LangChain"
description: "دمج LemonData مع LangChain باستخدام واجهات chat و embeddings القياسية المتوافقة مع OpenAI"
---
...
<AccordionGroup>
  <Accordion title="مرّر `base_url` بشكل صريح">
    الإعداد الأكثر موثوقية لـ LemonData هو تمرير `base_url="https://api.tokenlab.sh/v1"` مباشرةً إلى `ChatOpenAI` و `OpenAIEmbeddings` بدلًا من الاعتماد على الأسماء المستعارة الأقدم لمتغيرات البيئة.
  </Accordion>
