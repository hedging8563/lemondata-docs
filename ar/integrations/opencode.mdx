...
**المسار الرئيسي**: OpenAI-compatible

**مستوى الدعم**: مسار مدعوم
</Note>

OpenCode هو مساعد برمجة AI مفتوح المصدر يعمل داخل الطرفية الخاصة بك. وهو يدعم عدة مزوّدي LLM ويمكن تهيئته لاستخدام API الخاصة بـ LemonData للوصول إلى مئات النماذج.
