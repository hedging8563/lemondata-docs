...
<Warning>
تعامل مع هذا التكامل على أنه تجريبي: لا يوثق Gemini CLI حاليًا مسارًا ثابتًا لاستخدام Base URL مخصص بأسلوب LemonData. إذا كنت تحتاج إلى تكامل LemonData مدعوم على الطرفية، فاختر Codex CLI أو Claude Code أو OpenCode.
</Warning>
