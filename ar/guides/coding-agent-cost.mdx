...
[Semantic cache](/ar/guides/caching) من TokenLab يطابق الطلبات بالمعنى لا بالنص الحرفي. هذا قوي لـ Coding Agents لأن:
...
[Prompt caching من المزود](/ar/guides/prompt-cache) يعمل تلقائيًا عبر TokenLab. System prompts الطويلة — التي تتضمنها Coding Agents دائمًا — تُخزَّن على مستوى المزود:
