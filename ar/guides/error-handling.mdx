...
| النوع | الرمز | الوصف |
|------|------|-------------|
| `insufficient_balance` | `insufficient_balance` | رصيد الحساب غير كافٍ (لنقاط النهاية المتوافقة مع OpenAI) |
| `insufficient_balance_error` | `insufficient_balance` | رصيد الحساب غير كافٍ (لنقاط النهاية المتوافقة مع Anthropic) |
