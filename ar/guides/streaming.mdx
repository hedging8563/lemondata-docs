...
بالنسبة إلى عمليات التكامل الجديدة بأسلوب OpenAI، يُفضَّل استخدام **Responses streaming** أولًا. وإذا كان إطار العمل لديك لا يزال يستخدم Chat Completions streaming، فإن TokenLab يدعم مسار التوافق هذا أيضًا.
