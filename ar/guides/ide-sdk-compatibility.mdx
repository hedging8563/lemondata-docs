...
|-----------------|----------|---------------|-------|
| **OpenAI SDK** | Python/JS/Go | Supported core path | Chat Completions and Embeddings are the default documented path; some Responses-only fields are not guaranteed across every model and routed path |
