...
| **Gemini CLI** | أفضل جهد / تجريبي | Gemini | تدفق عنوان URL الأساسي المخصص لـ LemonData ليس عقدًا مستقرًا مع المصدر الأصلي |
...
| **LlamaIndex** | Python | مدعوم عبر `OpenAILike` | استخدم `OpenAILike`، وليس فئات OpenAI المدمجة، لبوابات الطرف الثالث مثل LemonData |
