...
description: "الحصول على حالة ونتائج مهمة إنشاء نموذج 3D"
---

قم بعمل polling لهذا Endpoint للتحقق من حالة مهمة إنشاء نموذج 3D الخاص بك.

## بارامترات المسار

<ParamField path="id" type="string" required>
  معرف (ID) مهمة إنشاء نموذج 3D.
</ParamField>
...
<ResponseField name="model_url" type="string">
  رابط URL لتنزيل ملف نموذج 3D (عند الاكتمال).
</ResponseField>

<ResponseField name="glb_url" type="string">
  رابط URL لتنزيل النموذج بتنسيق GLB (عند توفره).
</ResponseField>

<ResponseField name="fbx_url" type="string">
  رابط URL لتنزيل النموذج بتنسيق FBX (عند توفره).
</ResponseField>
