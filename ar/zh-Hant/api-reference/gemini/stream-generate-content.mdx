---
title: "بث محتوى التوليد"
openapi: "POST /v1beta/models/{model}:streamGenerateContent"
description: "بث محتوى التوليد باستخدام تنسيق Google Gemini API"
---

نسخة البث لنقطة النهاية `generateContent` الخاصة بـ Gemini. تُرجع Server-Sent Events.
...
<ParamField query="key" type="string">
  مفتاح API (بديل للمصادقة عبر الرأس).
</ParamField>

## جسم الطلب

مماثل لـ [توليد المحتوى](/api-reference/gemini/generate-content).

## الاستجابة

تُرجع بثاً من كائنات JSON، حيث يحتوي كل كائن على استجابة جزئية.
