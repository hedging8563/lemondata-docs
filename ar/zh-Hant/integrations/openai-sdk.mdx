---
title: "OpenAI SDK"
description: "استخدم LemonData من خلال OpenAI SDK الرسمي"
---

## نظرة عامة

LemonData متوافق تماماً مع OpenAI SDK. ما عليك سوى تغيير base URL للوصول إلى أكثر من 300 نموذج.
...
يعمل تماماً بنفس طريقة OpenAI API:
...
## الصوت - تحويل الكلام إلى نص (Transcription)
...
تكمن الميزة الأساسية لـ LemonData في القدرة على الوصول إلى عدة مزودين:
