...
إذا لم تعد المهمة موجودة أو لم يعد بالإمكان حلّها عبر عقد المهام غير المتزامنة العامة، يعيد LemonData القيمة `async_task_not_found` مع الرسالة `Task not found or no longer available.`
</Info>
