...
<Warning>
توثّق هذه النقطة حاليًا مسار التعديل متعدد الأجزاء على نمط DALL-E. تستخدم عائلات الصور الأخرى المدعومة على LemonData `POST /v1/images/generations` مع `operation: "image-to-image"` ومدخلات JSON مثل `image_url` حيثما كان ذلك مدعومًا.
</Warning>
