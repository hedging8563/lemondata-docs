...
<ParamField body="size" type="string" default="1024x1024">
  حجم الصورة. استخدمه مع عائلات الصور على نمط OpenAI والنماذج الأخرى التي تقبل أحجامًا دقيقة بالبكسل.

  بالنسبة لعائلات صور Google Gemini، يُعامل `size` كاسم مستعار متوافق يطابق العقد العام لـ `aspect_ratio` و`resolution` عندما يكونان مدعومين. يُفضَّل إرسال `aspect_ratio` مباشرةً لهذه النماذج.
</ParamField>
