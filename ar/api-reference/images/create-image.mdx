...
<ParamField body="size" type="string" default="1024x1024">
  ...
  بالنسبة إلى `gpt-image-2`، يتم تمرير `size` إلى مسار upstream المتوافق مع OpenAI ويمكنه استخدام أي قيمة صالحة يقبلها النموذج حاليًا. لا تُعد `aspect_ratio` و`resolution` جزءًا من العقد العام الحالي في LemonData لـ `gpt-image-2`.
