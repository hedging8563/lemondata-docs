...
النماذج المدعومة هي `marble-1.0` و `marble-1.1` و `marble-1.1-plus`. توثق World Labs النموذج `marble-1.0-draft`، لكن TokenLab لا يتيح draft generation في هذا endpoint حالياً.
...
يغطي هذا endpoint توليد العالم و polling. لا يقوم TokenLab حالياً بتمرير تحميل media asset في World Labs أو قائمة العوالم أو حذف العوالم أو أدوات pano المستقلة.
