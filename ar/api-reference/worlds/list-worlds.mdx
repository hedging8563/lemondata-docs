...
اعرض عوالم World Labs Marble المكتملة التي تم إنشاؤها عبر TokenLab. النتائج محصورة بمؤسستك؛ ولا يعرض TokenLab القائمة الكاملة لحساب upstream المشترك.
...
<ParamField body="status" type="string">
  مرشح حالة اختياري. يعيد TokenLab worlds مكتملة عند `SUCCEEDED`؛ الحالات الأخرى تخص نقطة مهام الإنشاء.
</ParamField>
