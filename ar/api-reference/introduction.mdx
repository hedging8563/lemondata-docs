---
title: 'مرجع API'
description: 'المرجع الكامل لواجهة برمجة تطبيقات LemonData API'
---
...
احصل على مفتاح API الخاص بك من [لوحة التحكم (Dashboard)](https://lemondata.cc/dashboard).
