...
يقوم TokenLab بإدارة التخزين المؤقت تلقائيًا لتحسين الأداء وتقليل التكاليف. على الرغم من عدم وجود نقطة نهاية (endpoint) عامة لمسح إدخالات التخزين المؤقت، إلا أن لديك تحكمًا كاملاً في سلوك التخزين المؤقت من خلال عناصر التحكم على مستوى الطلب.

هذه الصفحة هي دليل للتخزين المؤقت من جهة الطلب.

لصفحات مرجعية API الصارمة، راجع:

- [إرسال ملاحظات حول التخزين المؤقت](/api-reference/cache/submit-cache-feedback)
- [الحصول على إحصاءات ملاحظات ذاكرة التخزين المؤقت](/api-reference/cache/get-cache-feedback-stats)
...
| النوع | التأثير |
|------|--------|
| `no_cache` | يتخطى البحث والكتابة في التخزين المؤقت، ويحصل دائمًا على استجابة جديدة |
...
استخدم معرّف request/cache entry الناتج عن cache hit داخل مؤسستك؛ يتم رفض المعرّفات العشوائية.
