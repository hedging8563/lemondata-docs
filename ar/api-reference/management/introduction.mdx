...
- يشير logicalModel إلى اسم النموذج المنطقي العام الذي طلبه العميل.
- يشير modelVendor إلى مزود النموذج العام، وليس المسار الفيزيائي المخفي.
- scene هو مشهد الطلب العام المشتق من الـ endpoint أو من نوع المهمة.
- يعني accessChannel=platform أن الطلب تمت محاسبته عبر قناة المنصة الخاصة بـ LemonData.
- يعني accessChannel=byok أن الطلب استخدم مفتاح مزود upstream الخاص بك.
