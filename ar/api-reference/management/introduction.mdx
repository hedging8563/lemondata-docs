...
description: "أدر مفاتيح API الخاصة بالمؤسسة واسترجع الاستخدام والفوترة على مستوى المفتاح باستخدام رمز إدارة."
---

## نظرة عامة

تتيح لك واجهة الإدارة إدارة مفاتيح API الخاصة بالمؤسسة واسترجاع الاستخدام والفوترة لمفتاح محدد دون استخدام مفتاح استدلال عادي.
...
- افتراضيًا يتم تفسير `limitAmount` في الطلب على أنه USD. اضبط `limitCurrency: "CNY"` لإرسال حد بالرنمينبي، وسيقوم الخادم بتحويله إلى USD باستخدام سعر الصرف الحالي قبل التخزين.
