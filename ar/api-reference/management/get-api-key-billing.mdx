...
تعيد نقطة النهاية هذه تجميعات فوترة قائمة على الاستهلاك لمفتاح API المحدد، بما في ذلك التكلفة الإجمالية وإجمالي الطلبات والاستخدام حسب وحدة الفوترة، إضافة إلى التفصيلات حسب اسم النموذج المطلوب (`model`) والمزوّد و`scene` و`` وفئة الـ cache واتجاه التكلفة اليومي.
