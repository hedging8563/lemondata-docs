...
إذا لم تعد المهمة موجودة أو لم يعد بالإمكان حلها عبر عقد المهمة غير المتزامنة العام، فتعيد LemonData القيمة `async_task_not_found` مع الرسالة `Task not found or no longer available.`
</Info>
