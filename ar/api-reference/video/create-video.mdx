...
إذا كان النموذج يدعم التكييف المخصص بالصور المرجعية، فاستخدم `operation=reference-to-video`. وفي العقد العام لـ LemonData تُمرَّر المراجع عبر `reference_images`.
