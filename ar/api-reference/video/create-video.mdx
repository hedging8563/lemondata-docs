...
<ParamField body="reference_images" type="array">
  صور مرجعية للتدفقات التي تدعم التكييف المرجعي المخصص. العدد المدعوم يعتمد على النموذج. بالنسبة إلى `seedance-2.0` و `seedance-2.0-fast`، تدعم TokenLab حاليًا ما يصل إلى 9 صور مرجعية، بالإضافة إلى ما يصل إلى 3 مقاطع فيديو مرجعية و3 ملفات صوت مرجعية. يُفضَّل استخدام روابط `https` العامة، كما تقبل النماذج المتوافقة أيضًا روابط `data:`.
</ParamField>
