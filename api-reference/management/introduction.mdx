...
| `/v1/management/reseller/settlement-multipliers` | GET | Private reseller settlement multipliers; requires `reseller_settlement:read` |
...
- Reseller settlement multipliers expose private partner settlement terms only. They do not include official prices, platform prices, upstream cost, gross profit, or platform profit.
