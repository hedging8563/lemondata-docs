...
This endpoint returns consumption-only billing aggregates for the selected API key, including total cost, total requests, usage unit breakdowns, and breakdowns by requested model name (`model`), vendor, `scene`, ``, cache class, plus a daily cost trend.
