...
<ParamField body="draft" type="boolean">
  Seedance 1.5 Pro draft workflow flag. Use `draft=true` to create a draft task on draft-capable Seedance routes. Do not send it together with `draft_task_id`.
</ParamField>
