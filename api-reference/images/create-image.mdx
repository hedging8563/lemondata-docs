...
<ParamField body="resolution" type="string">
  ...
  Supported on `gemini-3-pro-image-preview`, `nano-banana-pro`, `nano-banana-2`, and similar high-resolution families. Typical values are `1k`, `2k`, and `4k`. Do not send this parameter to Gemini Flash image families unless the model explicitly documents it. For xAI Grok Imagine image models, use `1k` or `2k`.
</ParamField>
