...
<ParamField body="size" type="string" default="1024x1024">
  ...
  For `gpt-image-2`, `size` is forwarded to the OpenAI-compatible upstream path and may use any value currently accepted by the model. `aspect_ratio` and `resolution` are not part of the current LemonData public contract for `gpt-image-2`.
