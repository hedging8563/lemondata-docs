...
<ParamField body="model" type="string" required>
  ID of the model to use. See [Models](/models/overview) for available options.
</ParamField>
...
<ParamField body="tools" type="array">
  A list of tools the model may call. See [Function Calling](/guides/function-calling).
</ParamField>
