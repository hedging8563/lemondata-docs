...
<ParamField body="messages" type="array" required>
  ...
  For multimodal production traffic, prefer public `https` URLs. TokenLab will translate these media blocks into the provider-specific request shape required by the routed physical model.
</ParamField>
...
<ParamField body="cache_control" type="object">
  TokenLab cache control options.
