...
<ResponseField name="lemondata" type="object">
  TokenLab-specific public metadata. The detail route can include `category`, `pricing_unit`, `capability_flags`, `supported_operations`, `pricing_provenance`, `public_contract_summary`, the full `public_contract`, and scene-level `agent_preferences` for non-chat recommendation snapshots.
</ResponseField>
