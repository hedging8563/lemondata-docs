...
[Cache ngữ nghĩa](/guides/caching) của TokenLab khớp các yêu cầu theo ý nghĩa, không phải văn bản chính xác. Điều này rất mạnh mẽ cho coding agent vì:
...
[Cache prompt upstream](/guides/prompt-cache) được tự động hóa qua TokenLab. Các system prompt dài — mà coding agent luôn bao gồm — được cache ở cấp nhà cung cấp:
...
| TokenLab + cả hai cache | ~$2–5 | ~$320–800 |
