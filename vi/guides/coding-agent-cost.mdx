...
[Cache ngữ nghĩa](/guides/caching) của LemonData khớp các yêu cầu theo ý nghĩa, không phải văn bản chính xác. Điều này rất mạnh mẽ cho coding agent vì:
...
[Cache prompt upstream](/guides/prompt-cache) được tự động hóa qua LemonData. Các system prompt dài — mà coding agent luôn bao gồm — được cache ở cấp nhà cung cấp:
...
<AccordionGroup>
  ...
  <Accordion title="Cursor">
    Cài đặt → Mô hình → Khóa API OpenAI: `sk-your-key`, URL cơ sở: `https://api.lemondata.cc/v1`
