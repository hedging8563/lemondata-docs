...
| Loại | Mã | Mô tả |
|------|------|-------------|
| `insufficient_balance` | `insufficient_balance` | Số dư tài khoản không đủ (endpoint tương thích OpenAI) |
| `insufficient_balance_error` | `insufficient_balance` | Số dư tài khoản không đủ (endpoint tương thích Anthropic) |
