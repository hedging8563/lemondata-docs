...
|------|-------|--------------|------|
| **Platform Cache** | LemonData | Khớp nối tương đồng ngữ nghĩa | Miễn phí (không gọi API) |
...
|----------|---------------------|------------------|------------|
| **Anthropic** | Giảm 90% | Bằng giá đầu vào | 1024 |
...
- **Cache** (xanh da trời): Khớp platform semantic cache - chi phí bằng 0
...
Ghi cache: 2,000 tokens × $3.00/1M = $0.0060
Tổng cộng: $0.0084 (Tiết kiệm 72%)
```
...
| **Chi phí** | Miễn phí (không gọi API) | Mức giá ưu đãi |
