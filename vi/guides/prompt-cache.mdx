...
Ngoài [platform semantic cache](/guides/caching) của TokenLab, nhiều nhà cung cấp AI cũng cung cấp tính năng **prompt caching** của riêng họ. Đây là một cơ chế caching riêng biệt hoạt động ở cấp độ nhà cung cấp (Anthropic, OpenAI, DeepSeek, v.v.).
...
|------|-------|--------------|------|
| **Platform Cache** | TokenLab | Khớp nối tương đồng ngữ nghĩa | 10% giá thường |
...
<Info>
Các mức giảm giá được áp dụng tự động. TokenLab chuyển tiếp mức giá cache của nhà cung cấp trực tiếp đến bạn.
</Info>
