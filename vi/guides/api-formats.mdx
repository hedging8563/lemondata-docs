...
TokenLab hỗ trợ **ba định dạng API gốc** với một khóa API duy nhất. Chọn định dạng phù hợp nhất với trường hợp sử dụng của bạn — không cần thay đổi cấu hình.
...
Nếu TokenLab không thể định tuyến yêu cầu có công cụ native tới một đường upstream hỗ trợ định dạng native, hệ thống sẽ trả lỗi unsupported-field rõ ràng thay vì âm thầm bỏ công cụ hoặc giả vờ đó là hàm Chat Completions. Công cụ hàm do người dùng định nghĩa vẫn là đường công cụ dễ di chuyển nhất.
...
Sức mạnh của TokenLab: sử dụng **bất kỳ SDK nào** với **bất kỳ mô hình nào**. Cổng sẽ tự động xử lý việc chuyển đổi định dạng.
...
|----------|:---:|:---:|:---:|:---:|
| **TokenLab** | ✅ Tất cả mô hình | ✅ Tất cả mô hình | ✅ Tất cả mô hình | ✅ Tất cả mô hình |
