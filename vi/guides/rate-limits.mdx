...
| **Partner** | 3,000 | Dành cho đối tác tích hợp |
| **VIP** | 10,000 | Người dùng có khối lượng sử dụng cao |

<Note>
  Giới hạn tốc độ có thể thay đổi. Liên hệ support@lemondata.cc để yêu cầu giới hạn tùy chỉnh.
</Note>
...
Hoặc gửi email tới support@lemondata.cc với:
