...
TokenLab cung cấp một hệ thống caching thông minh có thể giảm đáng kể chi phí API và độ trễ phản hồi của bạn. Hệ thống caching của chúng tôi vượt xa việc khớp yêu cầu đơn thuần - nó hiểu được **ý nghĩa ngữ nghĩa** trong các prompt của bạn.
...
TokenLab sử dụng hệ thống caching hai lớp:
...
- **Giai đoạn 2 (Toàn bộ ngữ cảnh)**: Độ tương đồng ≥95% bao gồm cả ngữ cảnh hội thoại
...
| Chế độ       | Mô tả                                                                  |
| ------------ | ---------------------------------------------------------------------- |
| **Mặc định**  | Đã bật cache, có thể chia sẻ với các yêu cầu tương tự                  |
...
<Accordion title="Chuẩn hóa định dạng prompt">Định dạng nhất quán giúp cải thiện việc khớp ngữ nghĩa.</Accordion>
