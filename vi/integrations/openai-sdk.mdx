---
title: "OpenAI SDK"
description: "Sử dụng LemonData với các OpenAI SDK chính thức và các client tương thích với OpenAI"
---

## Overview

LemonData hoạt động với các OpenAI SDK chính thức bằng cách trỏ client tới `https://api.lemondata.cc/v1`.
