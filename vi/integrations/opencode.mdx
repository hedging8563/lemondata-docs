...
<Note>
Dùng `@ai-sdk/openai-compatible` cho khả năng tương thích kiểu chat-completions. Nếu bạn thực sự cần `/v1/responses`, hãy đổi gói provider sang `@ai-sdk/openai`.
</Note>
...
<AccordionGroup>
  <Accordion title="Lỗi kết nối">
    - Xác minh `options.baseURL` đã được thiết lập thành `https://api.lemondata.cc/v1`
