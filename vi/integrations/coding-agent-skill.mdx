...
description: "Cài skill tích hợp TokenLab API đang được duy trì và hướng dẫn coding agent khám phá model, đọc hợp đồng công khai và phục hồi từ lỗi API."
---
...
Nếu bạn đã cài skill trước khi repository TokenLab được dọn dẹp, hãy chạy lại cùng lệnh. Gói công khai hiện nhỏ hơn và không còn phụ thuộc vào script tìm kiếm cục bộ được tạo.
