...
<AccordionGroup>
  ...
  <Accordion title="Những coding agent nào được hỗ trợ?">
    Bất kỳ công cụ nào hỗ trợ các tệp skill/rules: Claude Code, Cursor, GitHub Copilot, Windsurf và nhiều hơn nữa. Trình cài đặt `npx skills add` sẽ tự động phát hiện và cài đặt cho tất cả các công cụ được hỗ trợ.
  </Accordion>
