---
title: "Anthropic SDK"
description: "Sử dụng LemonData với Anthropic SDK để tương thích với Messages API gốc của Claude"
---
...
Trong số các tuyến SDK được tài liệu hóa, đây là một trong những đường dẫn LemonData được hỗ trợ mạnh nhất cho các tính năng gốc của Claude.
