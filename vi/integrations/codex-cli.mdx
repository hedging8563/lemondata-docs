...
Đối với LemonData, Codex CLI có thể sử dụng `/v1/responses`, nhưng bạn nên coi đó là một đường dẫn tương thích nâng cao. Một số tính năng chỉ dành cho Responses không được đảm bảo hoạt động trên mọi mô hình và đường dẫn.
...
<AccordionGroup>
  ...
  <Accordion title="Không tìm thấy model">
    ...
    - Xác minh khả dụng của model tại [lemondata.cc/en/models](https://lemondata.cc/vi/models)
  </Accordion>
  ...
  <Accordion title="/compact hoặc tự động nén thất bại">
    ...
    - Giữ `wire_api = "responses"` và `base_url = "https://api.lemondata.cc/v1"`
  </Accordion>
</AccordionGroup>
