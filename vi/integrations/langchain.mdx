...
<AccordionGroup>
  <Accordion title="Truyền `base_url` một cách tường minh">
    Cấu hình LemonData đáng tin cậy nhất là truyền `base_url="https://api.tokenlab.sh/v1"` trực tiếp vào `ChatOpenAI` và `OpenAIEmbeddings` thay vì phụ thuộc vào các alias biến môi trường cũ hơn.
  </Accordion>
