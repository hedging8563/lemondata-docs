---
title: "Vercel AI SDK"
description: "Tích hợp LemonData với Vercel AI SDK bằng nhà cung cấp tương thích OpenAI hoặc nhà cung cấp Responses native"
---
...
Đối với LemonData, lựa chọn mặc định ổn định nhất trong Vercel AI SDK là **nhà cung cấp tương thích OpenAI**.

Nếu bạn cần cụ thể hành vi **Responses native**, bạn có thể chuyển sang nhà cung cấp OpenAI và giữ nguyên URL cơ sở của LemonData.
