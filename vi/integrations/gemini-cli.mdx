...
Google Gemini CLI là một công cụ dòng lệnh để tương tác với các mô hình Gemini. LemonData cung cấp một endpoint tương thích cho phép bạn sử dụng Gemini CLI với quyền truy cập vào hàng trăm mô hình.


<Warning>
Hãy coi đây là tích hợp thử nghiệm: Gemini CLI hiện chưa tài liệu hóa một quy trình Base URL tùy chỉnh kiểu LemonData theo cách ổn định. Nếu bạn cần một luồng LemonData trên terminal được hỗ trợ rõ ràng, hãy ưu tiên Codex CLI, Claude Code hoặc OpenCode.
</Warning>
