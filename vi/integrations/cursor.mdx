...
<Warning>
Khóa API tùy chỉnh của Cursor chỉ áp dụng cho các model chat tiêu chuẩn. Tab Completion và các tính năng chuyên biệt khác do Cursor quản lý sẽ tiếp tục dùng các nhà cung cấp tích hợp sẵn của Cursor.
</Warning>
...
|-------|----------|
| `gpt-4o` | Lập trình chung, gỡ lỗi, chat |
| `gpt-4o-mini` | Chỉnh sửa nhanh và prompt nhẹ |
