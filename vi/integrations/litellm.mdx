---
title: "LiteLLM"
description: "Dùng LiteLLM với TokenLab như provider upstream hoặc lớp gateway nội bộ"
---
...
- dùng TokenLab làm **upstream tương thích OpenAI** phía sau LiteLLM
- đặt LiteLLM phía trước TokenLab để xử lý virtual key, routing bổ sung hoặc observability tập trung
...
- Hãy coi TokenLab trước hết là upstream `custom_openai`
