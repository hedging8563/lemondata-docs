...
Anthropic hiện khuyến nghị dùng trình cài đặt gốc. Cách cài qua npm vẫn còn để tương thích, nhưng đã bị upstream xem là deprecated.

```bash
curl -fsSL https://claude.ai/install.sh | bash
```

Nếu bạn thực sự cần gói npm, hãy dùng:
...
<Warning>
Không dùng `sudo npm install -g` cho Claude Code.
</Warning>
