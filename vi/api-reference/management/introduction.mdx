---
title: "API Quản Lý"
description: "Quản lý API key của tổ chức và lấy usage cùng billing theo từng key bằng management token."
---

## Tổng Quan

Management API cho phép bạn quản lý API key của tổ chức và lấy usage cũng như billing cho một key cụ thể mà không cần dùng inference API key thông thường.
