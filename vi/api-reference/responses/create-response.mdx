...
Responses API là API hội thoại có trạng thái mới hơn của OpenAI. TokenLab hỗ trợ định dạng này như một đường dẫn tùy chọn nâng cao cho các mô hình tương thích; sử dụng `POST /v1/chat/completions` làm đường dẫn mặc định tương thích với OpenAI trừ khi bạn thực sự cần các hành vi đặc thù của Responses.
