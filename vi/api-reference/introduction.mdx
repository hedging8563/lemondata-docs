...
LemonData API **tương thích với OpenAI**, điều này có nghĩa là bạn có thể sử dụng OpenAI SDK chính thức chỉ với việc thay đổi base URL. Chúng tôi cũng hỗ trợ các định dạng yêu cầu gốc của **Anthropic** và **Gemini**.
