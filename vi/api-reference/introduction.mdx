...
- **cURL** - Sao chép các lệnh mẫu và thay thế `sk-your-api-key` bằng key thực của bạn
- **Postman** - Nhập [đặc tả OpenAPI](/openapi.json) của chúng tôi
- **SDK** - Sử dụng SDK OpenAI/Anthropic với base URL của chúng tôi
</Warning>
