...
<ParamField body="model" type="string" required>
  Model cần dùng (ví dụ: `gpt-image-2`, `flux-pro`, `qwen-image` hoặc `nano-banana-pro`). Dùng `GET /v1/models?recommended_for=image` để lấy danh sách đề xuất hiện tại.
</ParamField>
...
| `qwen-image` | Thường là task | Render chữ và bám prompt tốt |
