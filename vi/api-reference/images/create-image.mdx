...
<ParamField body="resolution" type="string">
  ...
  Được hỗ trợ trên `gemini-3-pro-image-preview`, `nano-banana-pro`, `nano-banana-2`, và các nhóm độ phân giải cao tương tự. Giá trị thường dùng là `1k`, `2k`, và `4k`. Không gửi tham số này cho các model Gemini Flash hình ảnh trừ khi tài liệu của model đó nói rõ. Với model hình ảnh xAI Grok Imagine, dùng `1k` hoặc `2k`.
</ParamField>
