---
title: "Lấy trạng thái âm nhạc"
openapi: "GET /v1/music/generations/{id}"
description: "Lấy trạng thái và kết quả của tác vụ tạo âm nhạc"
---

Gửi yêu cầu (poll) đến endpoint này để kiểm tra trạng thái của tác vụ tạo âm nhạc.

## Tham số đường dẫn

<ParamField path="id" type="string" required>
  ID của tác vụ tạo âm nhạc.
</ParamField>
...
<ResponseField name="audio_url" type="string">
  Liên kết tải xuống tệp âm thanh (khi hoàn tất).
</ResponseField>

<ResponseField name="video_url" type="string">
  Liên kết phiên bản video với hiệu ứng hình ảnh (khi hoàn tất).
</ResponseField>
...
<ResponseField name="lyrics" type="string">
  Lời bài hát được tạo hoặc cung cấp.
</ResponseField>
