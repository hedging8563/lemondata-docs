---
title: "Liệt kê các mô hình"
openapi: "GET /v1/models"
description: "Liệt kê tất cả các mô hình hiện có"
---
...
<ResponseField name="data" type="array">
  Mảng các đối tượng mô hình.

  Mỗi mô hình bao gồm:
  - `id` (string): Mã định danh mô hình
  - `object` (string): `model`
  - `created` (integer): Dấu thời gian tạo
  - `owned_by` (string): Nhà cung cấp mô hình
</ResponseField>
