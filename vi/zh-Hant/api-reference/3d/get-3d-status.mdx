...
description: "Lấy trạng thái và kết quả của tác vụ tạo 3D"
---

Gửi yêu cầu (poll) đến endpoint này để kiểm tra trạng thái tác vụ tạo mô hình 3D của bạn.

## Tham số đường dẫn

<ParamField path="id" type="string" required>
  ID của tác vụ tạo 3D.
</ParamField>
