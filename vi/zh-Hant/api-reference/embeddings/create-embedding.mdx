...
description: "Tạo các vector embedding đại diện cho văn bản đầu vào"
---

## Thân yêu cầu

<ParamField body="model" type="string" required>
  ID của mô hình embedding cần sử dụng (ví dụ: `text-embedding-3-small`).
</ParamField>

<ParamField body="input" type="string | array" required>
  Văn bản đầu vào cần tạo embedding. Có thể là một chuỗi hoặc một mảng các chuỗi.
</ParamField>
...
<ParamField body="dimensions" type="integer">
  Số lượng chiều đầu ra (tùy thuộc vào từng mô hình cụ thể).
</ParamField>

<ParamField body="user" type="string">
  Mã định danh duy nhất đại diện cho người dùng cuối của bạn, được sử dụng để giám sát lạm dụng.
</ParamField>

## Các mô hình hiện có

| Mô hình | Số chiều | Mô tả |
|-------|------------|-------------|
...
<ResponseField name="usage" type="object">
  Mức sử dụng Token bao gồm `prompt_tokens` và `total_tokens`.
</ResponseField>
