---
title: "OpenAI SDK"
description: "Sử dụng LemonData thông qua OpenAI SDK chính thức"
---

## Tổng quan

LemonData hoàn toàn tương thích với OpenAI SDK. Chỉ cần thay đổi `base URL`, bạn có thể truy cập hơn 300 mô hình khác nhau.
...
Cách thức hoạt động hoàn toàn giống với OpenAI API:
...
## Âm thanh - Chuyển đổi văn bản thành giọng nói (Text to Speech)
...
## Âm thanh - Chuyển đổi giọng nói thành văn bản (Transcription)
...
Ưu điểm cốt lõi của LemonData là khả năng truy cập vào nhiều nhà cung cấp khác nhau:
