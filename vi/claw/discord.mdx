...
Cấu hình hành vi của máy chủ (guild) trong phần **Channels** của LemonClaw WebUI:
...
<Note>
Discord sử dụng allowlist người dùng theo từng guild thay vì allowlist nhóm toàn cầu. Để lọc người dùng nâng cao theo từng guild, hãy cấu hình trực tiếp trong tệp cấu hình LemonClaw.
</Note>
