---
title: "Dify"
description: "LemonData를 Dify와 통합하여 LLM 애플리케이션 구축하기"
---
...
- 애플리케이션 로직 변경 없이 모델 간 전환
- 각 작업에 최적의 모델을 선택하여 비용 최적화
- 통합 빌링 및 사용량 추적
...
<AccordionGroup>
  ...
  <Accordion title="모델 라우팅 사용">
    작업에 따라 다른 모델을 구성하세요. 단순한 쿼리에는 빠른 모델을, 복잡한 추론에는 강력한 모델을 사용하세요.
  </Accordion>
