---
title: "Claude Code"
description: "LemonData를 Anthropic의 Claude Code CLI와 함께 사용하기"
---

## 개요

[Claude Code](https://docs.anthropic.com/en/docs/claude-code)는 AI 지원 코딩을 위한 Anthropic의 공식 CLI 도구입니다. LemonData를 API 제공업체로 사용하도록 설정할 수 있습니다.
...
영구적으로 적용하려면 쉘 프로필(`~/.bashrc`, `~/.zshrc` 등)에 이를 추가하세요.
...
| `claude-sonnet-4-5` | 균형 잡힌 성능, 코딩에 탁월함 |
...
<AccordionGroup>
  <Accordion title="연결 오류">
    Base URL이 정확히 `https://api.lemondata.cc`인지 확인하세요 (Anthropic SDK의 경우 `/v1` 접미사가 없습니다).
  </Accordion>
