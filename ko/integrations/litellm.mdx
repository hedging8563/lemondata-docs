---
title: "LiteLLM"
description: "LiteLLM를 TokenLab의 상류 제공자 또는 내부 게이트웨이 계층으로 사용하기"
---
...
- TokenLab를 LiteLLM 뒤의 **OpenAI 호환 upstream** 으로 사용
- LiteLLM를 TokenLab 앞단에 두고 가상 키, 추가 라우팅, 중앙 관측 기능을 담당하게 함
