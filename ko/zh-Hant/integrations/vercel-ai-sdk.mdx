---
title: "Vercel AI SDK"
description: "LemonData를 React 및 Next.js 애플리케이션용 Vercel AI SDK와 통합하기"
---

## 개요

Vercel AI SDK는 React, Next.js, Vue, Svelte 등의 프레임워크를 사용하여 AI 기반 스트리밍 애플리케이션을 구축하기 위한 TypeScript 툴킷입니다. LemonData는 OpenAI 호환 provider를 통해 원활하게 작동합니다.
...
<AccordionGroup>
  <Accordion title="더 나은 사용자 경험(UX)을 위해 스트리밍 사용하기">
    실시간 피드백을 제공하기 위해 채팅 애플리케이션에서는 항상 스트리밍을 사용하세요.
  </Accordion>

  <Accordion title="정교한 에러 처리">
    React 컴포넌트에서 적절한 Error Boundaries를 구현하세요.
  </Accordion>

  <Accordion title="API 키 보호">
    클라이언트 측 코드에 API 키를 노출하지 마세요. 반드시 서버 측 API 라우트를 사용해야 합니다.
  </Accordion>
</AccordionGroup>