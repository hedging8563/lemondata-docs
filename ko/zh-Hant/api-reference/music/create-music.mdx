...
description: "Suno를 사용하여 음악 생성 작업 생성"
---

AI를 사용하여 음악과 가사를 생성합니다. 이 API는 비동기 방식으로 작동하며, 완료 상태를 확인하기 위한 폴링(polling)용 작업 ID를 받게 됩니다.

## 요청 파라미터

<ParamField body="model" type="string" default="suno_music">
  사용할 모델: 음악 생성에는 `suno_music`, 가사 전용에는 `suno_lyrics`를 사용합니다.
</ParamField>
