...
<Steps>
  ...
  <Step title="이벤트 구독 설정">
    ...
    <Tip>
    LemonClaw WebUI에서 Feishu를 설정하면 Encrypt Key와 Verification Token이 **자동 생성**됩니다. 이 값들을 Feishu 개발자 콘솔에 복사하세요.
    </Tip>
  </Step>
...
LemonClaw WebUI의 **IM Integrations** 설정에서 그룹 채팅 동작을 설정하세요:
