---
title: "DingTalk"
description: "Stream 모드를 사용하여 LemonClaw 인스턴스를 DingTalk에 연결하세요"
---
...
- 엔터프라이즈 관리자 권한이 있는 [DingTalk](https://www.dingtalk.com/) 계정
- LemonClaw 인스턴스:
...
<Note>
DingTalk은 그룹에서 봇을 트리거하기 위해 **항상 @mention이 필요**합니다. 이는 플랫폼의 제한 사항이며 구성할 수 없습니다. DingTalk에서는 그룹 ID 필터링을 사용할 수 없습니다. 액세스를 제어하려면 Group Policy 설정을 사용하세요.
</Note>
