...
<ResponseField name="data" type="array">
  ...
  - `pricing` (object): 가격 정보
    - `input_per_1m` (string | null): 100만 입력 토큰당 USD 가격
    - `output_per_1m` (string | null): 100만 출력 토큰당 USD 가격
    - `per_request` (string | null): 요청당 USD 가격 (고정 가격 모델의 경우)
    - `is_lock_price` (boolean): 요청당 고정 가격 여부
