...
<ParamField body="size" type="string" default="1024x1024">
  ...
  `gpt-image-2` 의 경우 `size` 는 OpenAI 호환 upstream 경로로 그대로 전달되며, 해당 모델이 현재 허용하는 유효한 값을 사용할 수 있습니다. `aspect_ratio` 와 `resolution` 은 현재 LemonData 의 `gpt-image-2` 공개 계약에 포함되지 않습니다.
