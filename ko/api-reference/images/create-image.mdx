...
<ParamField body="resolution" type="string">
  ...
  `gemini-3-pro-image-preview`, `nano-banana-pro`, `nano-banana-2` 같은 고해상도 계열에서 지원됩니다. 일반적인 값은 `1k`, `2k`, `4k` 입니다. 모델이 명시적으로 문서화하지 않았다면 Gemini Flash 이미지 계열에는 보내지 마세요. xAI Grok Imagine 이미지 모델에는 `1k` 또는 `2k` 를 사용하세요.
</ParamField>
