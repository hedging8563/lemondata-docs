...
<ParamField body="model" type="string" required>
  사용할 모델(예: `gpt-image-2`, `flux-pro`, `qwen-image`, `nano-banana-pro`). 현재 추천 목록은 `GET /v1/models?recommended_for=image` 로 확인하세요.
</ParamField>
...
| `qwen-image` | 작업 기반인 경우가 많음 | 강한 텍스트 렌더링과 프롬프트 준수 |
