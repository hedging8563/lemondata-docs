...
비디오 생성은 비동기 방식으로 이루어집니다. 요청을 제출하면 작업 ID(`task ID`)를 받게 되며, 이후 결과를 확인하기 위해 폴링(poll)을 수행해야 합니다.
...
| 모델 | 유형 | 설명 |
|-------|------|-------------|
| `kling-video` | T2V/I2V | 사실적인 모션, 여러 버전 제공 (v1.0-v2.6) |
