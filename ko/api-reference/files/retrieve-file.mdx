...
<ResponseField name="filename" type="string">후속 호출과 지원 조사에 사용하는 식별자입니다.</ResponseField>
<ResponseField name="purpose" type="string">API가 반환하는 event 또는 message type입니다.</ResponseField>
