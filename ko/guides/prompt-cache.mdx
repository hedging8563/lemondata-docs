...
이 페이지는 TokenLab 별도 semantic cache가 아니라 upstream provider prompt cache를 설명합니다. 라우팅된 provider가 cache token을 보고하면 사용량과 청구에 반영됩니다.
...
<Info>
할인은 자동으로 적용됩니다. TokenLab는 제공자의 캐시 가격 정책을 그대로 사용자에게 전달합니다.
</Info>
