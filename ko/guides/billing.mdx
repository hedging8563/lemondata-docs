...
<Note>
  표시된 가격은 할인된 플랫폼 가격입니다. 실제 가격은 다를 수 있습니다. 현재 요율은 [요금 페이지](https://lemondata.cc/ko/pricing)에서 확인하세요.
</Note>
...
1. **대시보드 → API 키**로 이동합니다
2. 수정할 키를 클릭합니다
3. **사용량 제한(Usage Limit)**을 설정합니다
...
1. **대시보드 → 결제(Billing)**로 이동합니다
2. 거래 내역을 확인합니다
3. 인보이스를 PDF로 다운로드합니다
