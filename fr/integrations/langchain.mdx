---
title: "LangChain"
description: "Intégrez LemonData à LangChain à l’aide du chat et des embeddings standard compatibles OpenAI"
---
...
<AccordionGroup>
  <Accordion title="Transmettre `base_url` explicitement">
    La configuration LemonData la plus fiable consiste à transmettre `base_url="https://api.tokenlab.sh/v1"` directement à `ChatOpenAI` et `OpenAIEmbeddings` au lieu de dépendre d’anciens alias de variables d’environnement.
  </Accordion>
