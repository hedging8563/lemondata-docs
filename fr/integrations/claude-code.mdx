...
Anthropic recommande désormais l’installateur natif. L’installation via npm reste possible pour compatibilité, mais elle est dépréciée en amont.

```bash
curl -fsSL https://claude.ai/install.sh | bash
```

Si vous avez explicitement besoin du package npm, utilisez :
