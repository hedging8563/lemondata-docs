...
<Warning>
Cette intégration doit être considérée comme expérimentale : Gemini CLI ne documente pas actuellement de workflow stable avec une URL de base personnalisée de type LemonData. Si vous avez besoin d’une intégration LemonData réellement prise en charge, privilégiez Codex CLI, Claude Code ou OpenCode.
</Warning>
