---
title: "LiteLLM"
description: "Utiliser LiteLLM avec LemonData comme fournisseur amont ou comme couche de passerelle interne"
---
...
Pour LemonData, le chemin par défaut le plus propre consiste à utiliser le mode **OpenAI personnalisé / compatible OpenAI** de LiteLLM avec `api_base = https://api.tokenlab.sh/v1`.
