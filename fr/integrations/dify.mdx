---
title: "Dify"
description: "Intégrez LemonData à Dify en utilisant le fournisseur OpenAI et une URL de base personnalisée"
---
...
Dify fonctionne bien avec LemonData grâce à son flux de flux de fournisseur de modèles compatible OpenAI.
...
<Steps>
  ...
  <Step title="Saisir les paramètres LemonData">
    ...
    | URL de base de l’API / URL de base personnalisée | `https://api.lemondata.cc/v1` |
  </Step>
