---
title: "Dify"
description: "Intégrez TokenLab à Dify en utilisant le fournisseur OpenAI et une URL de base personnalisée"
---
...
Dify fonctionne bien avec TokenLab grâce à son flux de flux de fournisseur de modèles compatible OpenAI.
...
- définir une URL de base personnalisée sur `https://api.tokenlab.sh/v1`
...
2. Ouvrez [API Keys](https://tokenlab.sh/dashboard/api)
...
<Steps>
  ...
  <Step title="Saisir les paramètres TokenLab">
    ...
    | URL de base de l’API / URL de base personnalisée | `https://api.tokenlab.sh/v1` |
  </Step>
...
<AccordionGroup>
  <Accordion title="Erreur de connexion">
    ...
    - Vérifiez que le serveur Dify peut atteindre TokenLab via l’internet public
  </Accordion>
