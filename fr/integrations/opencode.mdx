...
<Note>
Utilisez `@ai-sdk/openai-compatible` pour la compatibilité de type chat-completions. Si vous avez explicitement besoin de `/v1/responses`, remplacez le package du provider par `@ai-sdk/openai`.
</Note>
