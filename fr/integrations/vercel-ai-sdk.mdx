---
title: "SDK AI Vercel"
description: "Intégrez LemonData avec le SDK AI Vercel en utilisant des fournisseurs compatibles OpenAI ou natifs Responses"
---
...
<AccordionGroup>
  <Accordion title="Préférez d’abord openai-compatible">
    Pour les passerelles tierces et les backends proxy, `@ai-sdk/openai-compatible` est généralement le point de départ le plus prévisible.
  </Accordion>
