...
LemonData fonctionne avec les SDK officiels OpenAI en pointant le client vers `https://api.lemondata.cc/v1`.

Pour la plupart des nouveaux projets, privilégiez **Chat Completions** comme chemin OpenAI-compatible par défaut. N'utilisez **Responses API** que lorsque vous avez explicitement besoin d'un comportement spécifique à Responses.
...
**Chemin principal** : OpenAI-compatible / Chat Completions
