...
| **Gemini CLI** | Best-effort / expérimental | Gemini | Le flux avec une URL de base LemonData personnalisée n'est pas un contrat amont stable |
...
| **LlamaIndex** | Python | Pris en charge via `OpenAILike` | Utilisez `OpenAILike`, pas les classes OpenAI intégrées, pour les passerelles tierces comme LemonData |
