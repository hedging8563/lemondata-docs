...
- **Supporté** signifie que nous documentons un chemin de configuration concret et que TokenLab expose la forme de protocole attendue par ce chemin.
...
- **Best-effort** signifie que l'intégration peut fonctionner, mais que le client en amont ne traite pas ce flux de passerelle personnalisé comme un contrat stable.
...
### Chemins de SDK & Frameworks documentés
...
| **Dify** | - | Supporté avec limites de périmètre | Le fournisseur OpenAI et les flux orientés chat-completions sont le chemin visé ; ne convient pas aux comportements WebSocket ou Responses spécifiques à Codex |
...
| `reasoning_effort` | string | Pour les modèles avec raisonnement |
