...
TokenLab propose un système de mise en cache intelligente qui peut réduire considérablement vos coûts d'API et la latence des réponses. Notre mise en cache va au-delà de la simple correspondance de requêtes - elle comprend la **signification sémantique** de vos prompts.
...
TokenLab utilise un système de mise en cache à deux couches :
...
- **Étape 2 (Contexte complet)** : ≥95 % de similitude incluant le contexte de la conversation
