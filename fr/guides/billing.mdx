...
1. Soumettez la tâche. LemonData peut effectuer un pré-prélèvement ou une réservation estimée afin de vérifier le solde et les limites de dépense de la clé API.
...
Si le dashboard ne reflète pas le règlement ou le remboursement après l'apparition de l'état terminal, contactez support@lemondata.cc.
