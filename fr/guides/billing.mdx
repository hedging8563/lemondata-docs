...
2. Pour le suivi de statut, utilisez d’abord le `poll_url` renvoyé et considérez `task_id` comme l’identifiant de tâche asynchrone
...
# Utilisez poll_url pour suivre le statut...
```
