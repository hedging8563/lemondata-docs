...
| **Partenaire** | 3,000 | Pour les partenaires d’intégration |
| **VIP** | 10,000 | Utilisateurs à fort volume |

<Note>
  Les limites de débit sont susceptibles d’être modifiées. Contactez support@lemondata.cc pour des limites personnalisées.
</Note>
...
1. Connectez-vous à votre [Dashboard](https://lemondata.cc/dashboard)
2. Allez dans **Settings → Account**
3. Contactez le support avec votre cas d’usage

Ou envoyez un email à support@lemondata.cc avec :
