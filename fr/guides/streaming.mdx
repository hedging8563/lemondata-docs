...
Pour les nouvelles intégrations de style OpenAI, privilégiez d’abord le **streaming Responses**. Si votre framework utilise encore le streaming Chat Completions, TokenLab prend également en charge cette voie de compatibilité.
