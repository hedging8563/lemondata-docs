...
Avec Seedance 2.0, les URL d’image et les data URL inline prises en charge sont automatiquement préparées comme matériaux TokenLab réutilisables avant la génération. Si la préparation dépasse 60 secondes, réessayez lorsque les `auto_material_asset_ids` renvoyés sont `ACTIVE`.
