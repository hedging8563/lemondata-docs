...
<Note>
Les endpoints compatibles OpenAI utilisent les types d'erreur publics et stables de LemonData, comme `rate_limit_exceeded`, `upstream_error` et `all_channels_failed`. Les endpoints compatibles Anthropic et Gemini utilisent leurs propres formats de réponse natifs.
</Note>
