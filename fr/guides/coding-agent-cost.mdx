...
Le [cache sémantique](/fr/guides/caching) de LemonData fait correspondre les requêtes par signification :
...
Le [Prompt Cache upstream](/fr/guides/prompt-cache) fonctionne automatiquement :
