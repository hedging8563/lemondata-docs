...
| `model_price_not_configured` | Le modèle existe en interne, mais n'est pas actuellement disponible pour les requêtes publiques |
...
Lorsqu'un modèle existe dans les workflows internes de gouvernance ou de tarification mais n'est pas encore exposé comme cible publique, LemonData renvoie :
