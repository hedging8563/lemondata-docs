...
| Type | Code | Description |
|------|------|-------------|
| `insufficient_balance` | `insufficient_balance` | Le solde du compte est insuffisant (endpoints compatibles OpenAI) |
| `insufficient_balance_error` | `insufficient_balance` | Le solde du compte est insuffisant (endpoints compatibles Anthropic) |
