...
En plus du [cache sémantique de plateforme](/guides/caching) de TokenLab, de nombreux fournisseurs d'IA proposent leur propre fonctionnalité de **cache de prompt**. Il s'agit d'un mécanisme de mise en cache distinct qui opère au niveau du fournisseur (Anthropic, OpenAI, DeepSeek, etc.).
...
|------|-------------|----------------|------|
| **Cache de plateforme** | TokenLab | Correspondance par similarité sémantique | 10 % du prix normal |
...
<Info>
Les remises sont appliquées automatiquement. TokenLab vous répercute la tarification cache du fournisseur.
</Info>
