...
<Steps>
  ...
  <Step title="Configurer l'abonnement aux événements">
    ...
    <Tip>
    Lorsque vous configurez Feishu dans la LemonClaw WebUI, l'**Encrypt Key** et le **Verification Token** sont générés automatiquement pour vous. Copiez ces valeurs dans la console développeur Feishu.
    </Tip>
  </Step>
...
Configurez le comportement du chat de groupe dans l'onglet **Channels** de votre WebUI :
