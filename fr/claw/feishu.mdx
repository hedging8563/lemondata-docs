...
<Steps>
  <Step title="Créer une application Feishu">
    1. Accédez à la [Feishu Open Platform](https://open.feishu.cn/app) (ou [Lark Developer](https://open.larksuite.com/app))
  ...
  <Step title="Configurer l'abonnement aux événements">
    ...
    3. Si vous y êtes invité, définissez l'**Encrypt Key** et le **Verification Token**
