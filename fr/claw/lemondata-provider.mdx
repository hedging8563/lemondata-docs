...
<Tip>
Vous voulez une installation hébergée à la place ? [Create a LemonClaw instance](/claw/introduction) — LemonData est déjà configuré par défaut, vous pouvez donc démarrer directement avec le WebUI.
</Tip>
