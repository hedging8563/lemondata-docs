...
<ParamField body="defaultModel" type="string">
  Modèle d'IA par défaut (ex. : `claude-opus-4-6`, `gpt-5.2`, `gemini-3-pro-preview`, `minimax-m2.1`, `kimi-k2.5`)
</ParamField>
...
Retourne **429 Too Many Requests** si la limite quotidienne est dépassée.
