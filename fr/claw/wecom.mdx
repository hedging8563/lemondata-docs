...
<Steps>
  ...
  <Step title="Configurer l'URL de rappel">
    ...
    2. Votre URL de rappel est affichée dans la LemonClaw WebUI lorsque vous développez la section WeCom :
    ```
    ...
    <Tip>
    L'URL de rappel est affichée dans la LemonClaw WebUI avec un bouton de copie. Assurez-vous que votre instance Claw est en cours d'exécution avant de vérifier l'URL.
    </Tip>
  </Step>
...
<Note>
Le support WeCom actuel dans LemonClaw reste un mode 1:1 centré utilisateur. Les mentions de groupe, threads et réponses complètes ne sont pas encore disponibles.
</Note>
