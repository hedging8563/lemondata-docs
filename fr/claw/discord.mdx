...
Configurez le comportement du serveur (guild) dans l'onglet **Channels** de votre WebUI :
...
<Note>
Discord utilise des listes blanches d'utilisateurs par serveur au lieu d'une liste blanche de groupe globale. Pour un filtrage avancé des utilisateurs par serveur, configurez-le directement dans le fichier de configuration LemonClaw.
</Note>
