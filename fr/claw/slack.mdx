...
Par défaut, Claw utilise la politique d'**appairage** pour Slack — les utilisateurs doivent effectuer un appairage unique avant de pouvoir interagir avec le bot. Cela empêche les membres non autorisés de l'espace de travail d'utiliser vos crédits IA.

<Tip>
La politique d'appairage est automatiquement configurée lorsque vous enregistrez vos paramètres Slack. Aucune configuration supplémentaire n'est nécessaire.
</Tip>
