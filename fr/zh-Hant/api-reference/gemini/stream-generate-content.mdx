...
description: "Générer du contenu en streaming au format API Google Gemini"
---

Version en streaming du point de terminaison `generateContent` de Gemini. Retourne des Server-Sent Events.
...
Retourne un flux d'objets JSON, chaque objet contenant une réponse partielle.
