...
description: "Créer une tâche de génération de modèle 3D"
---

Utilisez Tripo3D et d'autres fournisseurs pour générer des modèles 3D à partir de texte ou d'images. Il s'agit d'une API asynchrone.

## Corps de la requête (Request Body)

<ParamField body="model" type="string" default="tripo3d-v2.5">
  Le modèle à utiliser (par exemple : `tripo3d-v2.5`, `tripo3d-v2`).
</ParamField>
...
<ParamField body="image" type="string">
  Image encodée en Base64 pour la génération d'image en 3D.
</ParamField>

<ParamField body="image_url" type="string">
  URL de l'image pour la génération d'image en 3D.
</ParamField>
...
<ParamField body="style" type="string">
  Préréglage de style du modèle.
</ParamField>

<ParamField body="seed" type="integer">
  Valeur de seed pour une génération reproductible.
</ParamField>
...
<ResponseField name="id" type="string">
  ID de la tâche utilisé pour interroger le statut.
</ResponseField>
