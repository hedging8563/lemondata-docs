...
<ParamField body="input" type="string" required>
  Le texte à partir duquel générer l'audio. Maximum 4096 caractères.
</ParamField>

<ParamField body="voice" type="string" required>
  La voix à utiliser : `alloy`, `ash`, `ballad`, `coral`, `echo`, `fable`, `nova`, `onyx`, `sage`, `shimmer`, `verse`.
</ParamField>
...
| `ash` | Calme, posé |
| `ballad` | Mélodieux, expressif |
| `coral` | Chaleureux, amical |
| `echo` | Chaleureux, conversationnel |
| `fable` | Expressif, narratif |
| `nova` | Amical, clair |
| `onyx` | Profond, autoritaire |
| `sage` | Sage, réfléchi |
| `shimmer` | Doux, apaisant |
| `verse` | Dynamique, polyvalent |