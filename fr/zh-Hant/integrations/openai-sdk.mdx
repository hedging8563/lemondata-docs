---
title: "SDK OpenAI"
description: "Utilisez LemonData via le SDK OpenAI officiel"
---
...
Le fonctionnement est exactement le même que celui de l'API OpenAI :
...
## Audio - Synthèse vocale (Text to Speech)
...
L'avantage principal de LemonData est l'accès à de multiples fournisseurs :
