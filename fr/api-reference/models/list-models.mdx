...
<ResponseField name="data" type="array">
  ...
  - `tokenlab.request_format_summary` (object ou `null`) : Résumé de découverte non-chat léger, avec `public_operations`, `request_endpoint` et `request_endpoint_by_operation`
