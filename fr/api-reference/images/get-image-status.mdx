...
Si la tâche n’existe plus ou n’est plus disponible dans l’enregistrement public de tâche, TokenLab renvoie `async_task_not_found` avec le message `Task not found or no longer available.`
</Info>
