...
<ParamField body="image" type="file" required>
  L’image à modifier. Doit être un fichier PNG valide, inférieur à 4 Mo et carré. L’image doit contenir des zones transparentes là où les modifications sont souhaitées.
</ParamField>
