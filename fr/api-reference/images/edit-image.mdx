...
Note de compatibilité : si `input_fidelity` est envoyé avec `gpt-image-2`, TokenLab le supprime, car GPT Image 2 traite déjà les entrées d’image en haute fidélité.
</Note>
