...
<ParamField body="model" type="string" required>
  Modèle à utiliser (par exemple `gpt-image-2`, `flux-pro`, `qwen-image` ou `nano-banana-pro`). Consultez `GET /v1/models?recommended_for=image` pour la liste recommandée actuelle.
</ParamField>
...
| `qwen-image` | Souvent basé sur une tâche | Bon rendu du texte et respect du prompt |
