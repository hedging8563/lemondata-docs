...
<ParamField body="size" type="string" default="1024x1024">
  Taille de l’image. Utilisez ce champ pour les familles d’images au format OpenAI et pour les autres modèles qui acceptent des tailles exactes en pixels.

  Pour les familles d’images Google Gemini, `size` est un alias de compatibilité qui se projette sur le contrat public `aspect_ratio` et, lorsque c’est pris en charge, `resolution` du modèle. Préférez envoyer `aspect_ratio` directement pour ces modèles.
</ParamField>
