...
<Info>
Si `poll_url` est renvoyé, utilisez directement cette URL. Traitez `task_id` comme l’identifiant de tâche asynchrone pour les vérifications ultérieures.
</Info>
...
<ResponseField name="poll_url" type="string">
  URL relative à interroger pour obtenir les résultats (par ex., `/v1/images/generations/{task_id}`).
</ResponseField>
