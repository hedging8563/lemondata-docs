...
<ParamField body="size" type="string" default="1024x1024">
  ...
  Pour `gpt-image-2`, `size` est transmis au chemin upstream compatible OpenAI et peut utiliser toute valeur valide actuellement acceptée par le modèle. `aspect_ratio` et `resolution` ne font pas partie du contrat public LemonData actuel pour `gpt-image-2`.
