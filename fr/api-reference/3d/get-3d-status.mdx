...
Si la tâche n'existe plus ou ne peut plus être résolue via le contrat async-task public, LemonData renvoie `async_task_not_found` avec le message `Task not found or no longer available.`
</Info>
