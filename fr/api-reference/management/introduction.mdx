...
|-------|------|------------------|-------|
| name | string | requis, valeur par défaut Default Key, longueur 1-50 | Nom affiché, normalisé côté serveur |
| limitAmount | number \| null | min. 0, max. 100000 | null ou omis = illimité, 0 = aucun quota exploitable, valeur positive = plafond en USD |
...
| limitAmount | number \| null | min. 0, max. 100000 | null signifie illimité, 0 signifie quota nul |
