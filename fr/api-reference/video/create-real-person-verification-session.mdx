...
If `verification_status` is `succeeded`, call [Bind Real-Person Verification Result](/fr/api-reference/video/bind-real-person-verification-result). The [test console](https://tokenlab.sh/dashboard/seedance-assets) can be used to verify callback handling before you wire the flow into your product.
