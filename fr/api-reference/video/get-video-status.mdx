...
Si la tâche n'existe plus ou ne peut plus être résolue via le contrat public async-task, LemonData renvoie `async_task_not_found` avec le message `Task not found or no longer available.`
</Info>
