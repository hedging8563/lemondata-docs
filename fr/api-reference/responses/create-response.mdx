...
<ParamField body="previous_response_id" type="string">
  ID d'une réponse précédente à partir de laquelle poursuivre la conversation.
</ParamField>
...
<ParamField body="text" type="object">
  Options de configuration de génération de texte.
</ParamField>
...
<ParamField body="reasoning" type="object">
  Configuration du raisonnement pour les modèles avec capacités de raisonnement, tels que les variantes de la famille GPT-5.
...
<ResponseField name="created" type="integer">
  Timestamp Unix indiquant quand la réponse a été créée.
</ResponseField>
