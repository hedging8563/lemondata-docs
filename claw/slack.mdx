---
title: "Slack"
description: "Connect your LemonClaw instance to a Slack workspace using Socket Mode"
---

Add an AI assistant to your Slack workspace using Socket Mode — no public URL required. This guide works for both hosted Claw instances and self-hosted LemonClaw deployments.
...
Configure channel access in the **IM Integrations** settings of your LemonClaw WebUI:
