...
動画生成は非同期で行われます。リクエストを送信して `task ID` を受け取り、その後結果をポーリングします。

## リクエストボディ

<ParamField body="model" type="string" default="kling-video">
  動画モデル（例：`kling-video`、`veo3.1`、`wan2.6-i2v`）。
</ParamField>
...
<ParamField body="image_url" type="string">
  イメージ・トゥ・ビデオ（image-to-video）生成用のオプションの開始画像。
</ParamField>
