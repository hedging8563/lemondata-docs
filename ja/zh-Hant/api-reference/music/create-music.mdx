...
description: "Suno を使用して音楽生成タスクを作成します"
---

AI を使用して音楽と歌詞を生成します。これは非同期 API です。完了ステータスをポーリングするためのタスク ID が返されます。
...
<ParamField body="prompt" type="string" required>
  生成する音楽の説明。スタイル、気分、楽器などを含めることができます。
</ParamField>
