---
title: "OpenAI SDK"
description: "公式の OpenAI SDK を使用して LemonData を利用する"
---

## 概要

LemonData は OpenAI SDK と完全に互換性があります。base URL を変更するだけで、300 以上のモデルにアクセスできます。
...
LemonData の主な利点は、複数のプロバイダーにアクセスできる点にあります：
