...
<Warning>
Cursor のカスタム API キーが適用されるのは標準チャットモデルだけです。Tab Completion など Cursor 管理の専用機能は、引き続き Cursor の組み込みプロバイダーを使用します。
</Warning>
...
| モデル | 最適な用途 |
|-------|----------|
| `gpt-4o` | 一般的なコーディング、デバッグ、チャット |
| `gpt-4o-mini` | 高速な編集と軽量プロンプト |
