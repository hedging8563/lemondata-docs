---
title: "LiteLLM"
description: "LiteLLM を TokenLab の上流プロバイダーまたは内部ゲートウェイ層として使用します"
---
...
- TokenLab を LiteLLM の背後にある **OpenAI 互換 upstream** として使う
- LiteLLM を TokenLab の前段に置き、virtual key、追加ルーティング、集中 observability を担わせる
...
- TokenLab はまず `custom_openai` upstream として扱う
