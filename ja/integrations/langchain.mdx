---
title: "LangChain"
description: "標準の OpenAI 互換 chat と embeddings を使用して LemonData を LangChain に統合"
---
...
<AccordionGroup>
  <Accordion title="`base_url` を明示的に渡す">
    より信頼性の高い LemonData の設定方法は、古い environment-variable alias に依存するのではなく、`base_url="https://api.tokenlab.sh/v1"` を `ChatOpenAI` と `OpenAIEmbeddings` に直接渡すことです。
  </Accordion>
