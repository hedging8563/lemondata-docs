...
Alle Claw API-Endpunkte erfordern eine Authentifizierung über den `Authorization: Bearer sk-...` Header.
...
Erstellt eine neue Instanz und belastet das Guthaben Ihrer Organisation mit **$20** für 30 Tage.
...
<ParamField body="defaultModel" type="string">
  Standard-KI-Modell (z. B. `claude-opus-4-6`, `gpt-5.2`, `gemini-3-pro-preview`, `minimax-m2.5`, `kimi-k2.5`)
</ParamField>
...
<ParamField body="imConfig" type="object | null">
  Konfiguration der IM-Plattform aktualisieren (Telegram, Discord, etc.)
</ParamField>
...
Löscht und erstellt den Container neu, während die Daten (PVC) erhalten bleiben. Begrenzt auf **10 Rebuilds pro Tag**.
