...
<Steps>
  ...
  <Step title="Event-Abonnement konfigurieren">
    ...
    <Tip>
    Wenn Sie Feishu in der LemonClaw WebUI konfigurieren, werden Encrypt Key und Verification Token automatisch für Sie generiert. Kopieren Sie diese Werte in die Feishu-Entwicklerkonsole.
    </Tip>
  </Step>
