...
description: "Verbinden Sie MCP-Clients mit dem öffentlichen Modellkatalog, Modelldetails, Preisen und Anleitungen zu nativen Endpunkten von TokenLab."
---

Der [TokenLab MCP-Server](https://github.com/hedging8563/tokenlab-mcp-server) bietet MCP-kompatiblen Agenten eine schreibgeschützte Möglichkeit, TokenLab-Modelle zu entdecken, bevor sie Code schreiben oder eine API-Route auswählen.

Verwenden Sie ihn, wenn ein Agent verfügbare Modelle vergleichen, unterstützte Anfrageformate prüfen, Preise abrufen oder verstehen muss, welche native Endpunkt-Familie für eine Aufgabe zu verwenden ist.

<Note>
Die Tools für den öffentlichen Katalog erfordern keinen TokenLab API-Key. Der Server fungiert nicht als Proxy für kostenpflichtige Inferenzanfragen.
</Note>
...
5. Verwenden Sie `get_api_overview`, wenn der Agent eine kompakte Übersicht der TokenLab API-Familien benötigt.
...
<AccordionGroup>
  ...
  <Accordion title="Kann dieser Server kostenpflichtige TokenLab-Inferenz-APIs aufrufen?">
    Nein. Er ist absichtlich schreibgeschützt für öffentliche Katalog-, Vertrags-, Preis- und Übersichtsdaten. Verwenden Sie die TokenLab API direkt für Inferenz.
  </Accordion>
</AccordionGroup>
