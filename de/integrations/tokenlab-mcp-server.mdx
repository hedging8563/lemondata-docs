...
| Argumente | zuerst `-y`, dann `@tokenlabai/mcp-server` | Verwenden Sie `@tokenlabai/mcp-server@0.6.5`, um die aktuell geprüfte Version festzuschreiben. |
...
| `full` | 78 | 76 generierte Endpunkt-Tools plus die zwei zusammengesetzten Discovery-Tools. Fügt Response-Lebenszyklus, Batches, Welten, native Modell-Discovery und andere zugelassene Entwickleroperationen hinzu. |
