...
| Argumente | zuerst `-y`, dann `@tokenlabai/mcp-server` | Verwenden Sie `@tokenlabai/mcp-server@0.5.0`, um die aktuell geprüfte Version festzuschreiben. |
