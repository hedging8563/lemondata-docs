...
<CardGroup cols={2}>
  <Card title="In Cursor installieren" icon="arrow-pointer" href="https://cursor.com/en/install-mcp?name=tokenlab-model-catalog&config=eyJ0eXBlIjoic3RkaW8iLCJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkB0b2tlbmxhYmFpL21jcC1zZXJ2ZXIiXSwiZW52Ijp7IlRPS0VOTEFCX01DUF9UT09MX1BST0ZJTEUiOiJjYXRhbG9nIn19">
    Das öffentliche Profil `catalog` mit einem Klick in Cursor hinzufügen
  </Card>
  <Card title="In VS Code installieren" icon="code" href="https://vscode.dev/redirect/mcp/install?name=tokenlab-model-catalog&config=%7B%22type%22%3A%22stdio%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22%40tokenlabai%2Fmcp-server%22%5D%2C%22env%22%3A%7B%22TOKENLAB_MCP_TOOL_PROFILE%22%3A%22catalog%22%7D%7D">
...
Verwenden Sie für lokale stdio-Clients den Servernamen `tokenlab-model-catalog`, den Befehl `npx`, die getrennten Argumente `-y` und `@tokenlabai/mcp-server` sowie kein Arbeitsverzeichnis. Mit `@tokenlabai/mcp-server@0.6.17` fixieren Sie die aktuell geprüfte Version.
