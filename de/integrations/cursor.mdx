...
<Warning>
Benutzerdefinierte Cursor-API-Schlüssel gelten nur für Standard-Chat-Modelle. Tab Completion und andere von Cursor verwaltete Spezialfunktionen verwenden weiterhin die integrierten Anbieter von Cursor.
</Warning>
...
|-------|----------|
| `gpt-4o` | Allgemeines Coding, Debugging, Chat |
| `gpt-4o-mini` | Schnelle Edits und leichte Prompts |
