...
<AccordionGroup>
  ...
  <Accordion title="Welche Coding-Agenten werden unterstützt?">
    Jedes Tool, das Skill-/Rules-Dateien unterstützt: Claude Code, Cursor, GitHub Copilot, Windsurf und mehr. Der `npx skills add`-Installer erkennt diese automatisch und installiert sie für alle unterstützten Tools.
  </Accordion>
