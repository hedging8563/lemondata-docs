---
title: "✨ LemonData API-Integrations-Skill"
description: "Installieren Sie das gemeinsame LemonData API-Integrations-Skill für jeden Coding-Agenten, inklusive Agent-First-Fehlerbehebung."
---

<Note>
Dieses Skill zeigt Ihrem Coding-Agenten, wie er die **300+ KI-APIs** von LemonData allein anhand Ihrer Beschreibung integrieren kann. Es wird als gemeinsames agent-first Skill ausgeliefert und funktioniert mit jedem Coding-Agenten, der Skill- oder Rules-Dateien unterstützt.

Diese API ist **[Agent-First](/guides/agent-first-api)** — selbst wenn der Agent einen Modellnamen falsch errät, erklärt die Fehlermeldung exakt, wie er es korrigieren kann.
</Note>
...
Dadurch wird das gemeinsame Skill `lemondata-api-integration` aus dem LemonData-Skills-Repository installiert.

Wenn Ihr Tool den Installer nicht unterstützt, kopieren Sie den Ordner `skills/lemondata-api-integration/` aus dem Repository in das gemeinsame Skills- oder Rules-Verzeichnis Ihres Tools.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Welche Coding-Agenten werden unterstützt?">
    Es funktioniert mit jedem Coding-Agenten, der gemeinsame Skills- oder Rules-Verzeichnisse unterstützt. Wenn der Installer unterstützt wird, platziert `npx skills add` das gemeinsame `lemondata-api-integration`-Skill automatisch am erkannten Ort.
  </Accordion>
...
<Info>
**Haben Sie Fragen?** Besuchen Sie unsere [GitHub Issues](https://github.com/hedging8563/lemondata-skills/issues) oder kontaktieren Sie [support@lemondata.cc](mailto:support@lemondata.cc)
</Info>