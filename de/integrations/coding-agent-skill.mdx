...
Dadurch wird das gemeinsame `lemondata-api-integration` Skill aus dem TokenLab-Skills-Repository installiert.
...
<Info>
**Haben Sie Fragen?** Schauen Sie in unsere [GitHub Issues](https://github.com/hedging8563/lemondata-skills/issues) oder kontaktieren Sie [support@tokenlab.sh](mailto:support@tokenlab.sh)
</Info>
