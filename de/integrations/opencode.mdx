...
<Note>
Verwenden Sie `@ai-sdk/openai-compatible` für die Chat-Completions-Kompatibilität. Wenn Sie ausdrücklich `/v1/responses` benötigen, wechseln Sie das Provider-Paket zu `@ai-sdk/openai`.
</Note>
