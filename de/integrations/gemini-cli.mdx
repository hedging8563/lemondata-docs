...
<Warning>
Dies ist nur eine experimentelle Kompatibilitätslösung: Gemini CLI dokumentiert derzeit keinen stabilen LemonData-ähnlichen Custom-Base-URL-Workflow. Wenn Sie eine unterstützte LemonData-Terminalintegration benötigen, verwenden Sie bevorzugt Codex CLI, Claude Code oder OpenCode.
</Warning>
