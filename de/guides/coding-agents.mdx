...
<CardGroup cols={2}>
  ...
  <Card title="Semantisches Caching" icon="brain" href="/de/guides/caching">
    Ähnliche Anfragen liefern gecachte Antworten zu 90 % Rabatt. Coding Agents wiederholen ähnliche Abfragen ständig.
  </Card>
  <Card title="Prompt Cache Passthrough" icon="bolt" href="/de/guides/prompt-cache">
  ...
  <Card title="Modell-Fallback" icon="arrows-rotate" href="/de/guides/coding-agent-models#how-lemondata-routing-works">
