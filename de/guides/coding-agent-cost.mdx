...
TokenLabs [semantischer Cache](/de/guides/caching) matcht Anfragen nach Bedeutung, nicht nach exaktem Text:
...
[Upstream-Prompt-Cache](/de/guides/prompt-cache) funktioniert automatisch über TokenLab:
...
| TokenLab + beide Caches | ~$2–5 | ~$320–800 |
