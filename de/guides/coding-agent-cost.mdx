...
LemonDatas [semantischer Cache](/de/guides/caching) matcht Anfragen nach Bedeutung, nicht nach exaktem Text:
...
[Upstream Prompt Cache](/de/guides/prompt-cache) funktioniert automatisch über LemonData:

| Provider | Cache-Rabatt | Min. Tokens |
|----------|-------------|-------------|
