...
Zusätzlich zum [semantischen Plattform-Cache](/guides/caching) von TokenLab bieten viele AI-Provider ihre eigene **Prompt-Caching**-Funktion an. Dies ist ein separater Caching-Mechanismus, der auf Provider-Ebene (Anthropic, OpenAI, DeepSeek usw.) arbeitet.
...
|------|-------|--------------|------|
| **Plattform-Cache** | TokenLab | Semantischer Ähnlichkeitsabgleich | 10 % des normalen Preises |
...
<Info>
Rabatte werden automatisch angewendet. TokenLab gibt die Cache-Preise des Providers direkt an Sie weiter.
</Info>
