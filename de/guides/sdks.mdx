...
Für die genaue Support-Grenze sollten Sie die jeweiligen Integrationsseiten verwenden. In diesem Docs-Set bedeuten `recommended` oder `supported`, dass ein dokumentierter Setup-Pfad existiert. Es bedeutet jedoch nicht automatisch, dass jedes Framework-Helper oder jedes provider-spezifische Feature in diesem Repository per End-to-End-Regression getestet ist.
