...
<Note>
  Rate Limits können sich ändern. Kontaktieren Sie support@lemondata.cc für benutzerdefinierte Limits.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Kontaktieren Sie uns für höhere Limits">
    Wenn Sie höhere Limits benötigen, kontaktieren Sie support@lemondata.cc.
  </Accordion>
</AccordionGroup>
...
1. Melden Sie sich in Ihrem [Dashboard](https://lemondata.cc/dashboard) an
2. Gehen Sie zu **Settings → Account**
3. Kontaktieren Sie den Support mit Ihrem Anwendungsfall

Oder senden Sie eine E-Mail an support@lemondata.cc mit:
