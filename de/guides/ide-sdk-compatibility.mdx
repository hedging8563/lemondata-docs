...
LemonData stellt mehrere API-Formate bereit, sodass gängige Coding-Tools, SDKs und Frameworks sich mit minimalem Glue-Code integrieren können.
...
|------|---------------------|--------|-------------|
| **Cursor** | Unterstützt mit Einschränkungen | OpenAI-compatible | Funktioniert für BYOK-Standard-Chat-/Editor-Flows, nicht als Ersatz für von Cursor verwaltete Funktionen wie Tab Completion |
...
| **Gemini CLI** | Best-Effort / experimentell | Gemini | Der benutzerdefinierte LemonData-Base-URL-Flow ist kein stabiler Upstream-Vertrag |
| **OpenCode** | Unterstützt | OpenAI-compatible | Verwenden Sie standardmäßig einen OpenAI-kompatiblen Provider; wechseln Sie zu einem Responses-basierten Provider nur, wenn Sie ihn explizit benötigen |
...
| **LlamaIndex** | Python | Unterstützt über `OpenAILike` | Verwenden Sie `OpenAILike`, nicht die eingebauten OpenAI-Klassen, für Drittanbieter-Gateways wie LemonData |
