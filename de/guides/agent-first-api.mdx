...
Wenn ein Modell intern existiert, aber derzeit nicht für öffentliche Anfragen freigegeben ist:
...
Agents sollten dies als Plattform-Verfügbarkeitssignal behandeln, nicht als Tippfehler. Versuchen Sie dasselbe Modell erst erneut, nachdem es in `GET /v1/models` erscheint.
