...
Öffentliche Routen unterscheiden im Antwortkörper nicht zwischen Tippfehlern, versteckten, zurückgestellten oder nicht-öffentlichen Modellzuständen. Wenn ein Modell derzeit nicht über den öffentlichen Vertrag verfügbar ist, gibt TokenLab `model_not_found` zurück.
