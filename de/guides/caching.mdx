...
TokenLab bietet ein intelligentes Caching-System, das Ihre API-Kosten und Antwortlatenz erheblich reduzieren kann. Unser Caching geht über einfaches Request-Matching hinaus – es versteht die **semantische Bedeutung** Ihrer Prompts.
...
TokenLab verwendet ein zweistufiges Caching-System:
...
- **Stufe 2 (Vollständiger Kontext)**: ≥95% Ähnlichkeit einschließlich des Konversationskontexts
...
| Modus        | Beschreibung                                                |
| ------------ | ----------------------------------------------------------- |
| **Standard**  | Cache aktiviert, kann mit ähnlichen Anfragen geteilt werden |
