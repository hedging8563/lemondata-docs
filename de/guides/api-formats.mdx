...
description: "Verwenden Sie OpenAI-, Anthropic- oder Gemini-Formate mit einem einzigen API-Schlüssel"
---

## Überblick

LemonData unterstützt **drei native API-Formate** mit einem einzigen API-Schlüssel. Wählen Sie das Format, das am besten zu Ihrem Anwendungsfall passt – keine Konfigurationsänderungen erforderlich.
...
| **Native Funktionen** | Greifen Sie auf formatspezifische Fähigkeiten zu |
| **Einfache Migration** | Wechseln Sie von offiziellen APIs mit nur einer Änderung der Base-URL |
...
Die Magie von LemonData: Verwenden Sie **jedes SDK** mit **jedem Modell**. Das Gateway übernimmt automatisch die Formatkonvertierung.
...
<Note>
Während die formatübergreifende Nutzung für die meisten Funktionen funktioniert, erfordern formatspezifische Funktionen (wie Anthropic Extended Thinking) das native Format.
</Note>