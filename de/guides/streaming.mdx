...
Für neue OpenAI-ähnliche Integrationen sollten Sie zuerst **Responses streaming** bevorzugen. Falls Ihr Framework weiterhin Chat Completions streaming verwendet, unterstützt TokenLab auch diesen Kompatibilitätspfad.
