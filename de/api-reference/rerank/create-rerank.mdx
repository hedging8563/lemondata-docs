...
<ParamField body="top_n" type="integer">
  Anzahl der zurückzugebenden Top-Ergebnisse. Standardmäßig werden alle Dokumente zurückgegeben. Muss mindestens `1` sein und darf `documents.length` nicht überschreiten. LemonData hat derzeit keinen verwalteten, anbieterspezifischen niedrigeren Hard-Cap; falls ein Anbieter später einen veröffentlicht, muss diese Wahrheit zuerst in die rerank request-shape truth aufgenommen werden, bevor sie dokumentiert oder erzwungen wird.
</ParamField>
