...
Kompatibilitätshinweis: Wenn eine `gpt-image-2`-Anfrage `input_fidelity` enthält, entfernt TokenLab das Feld, weil GPT Image 2 Bildeingaben bereits automatisch mit hoher Treue verarbeitet.
</Note>
