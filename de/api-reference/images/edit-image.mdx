...
<Warning>
Dieser Endpunkt dokumentiert derzeit den DALL-E-Stil für multipart-Bearbeitung. Andere unterstützte Image-to-Image-Familien auf LemonData verwenden `POST /v1/images/generations` mit `operation: "image-to-image"` und JSON-Eingaben wie `image_url`, sofern unterstützt.
</Warning>
