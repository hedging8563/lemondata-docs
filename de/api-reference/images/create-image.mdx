...
<ParamField body="model" type="string" required>
  Zu verwendendes Modell (z. B. `gpt-image-2`, `flux-pro`, `qwen-image` oder `nano-banana-pro`). Die aktuelle Empfehlungsliste erhalten Sie mit `GET /v1/models?recommended_for=image`.
</ParamField>
...
| `qwen-image` | Oft task-basiert | Starke Textdarstellung und Prompt-Befolgung |
