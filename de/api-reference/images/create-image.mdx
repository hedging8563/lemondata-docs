...
<ParamField body="size" type="string" default="1024x1024">
  ...
  Für `gpt-image-2` wird `size` an den OpenAI-kompatiblen Upstream-Pfad weitergereicht und kann jeden aktuell vom Modell akzeptierten gültigen Wert verwenden. `aspect_ratio` und `resolution` gehören derzeit nicht zum öffentlichen LemonData-Vertrag für `gpt-image-2`.
