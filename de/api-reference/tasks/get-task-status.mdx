...
Wenn die Task nicht mehr existiert, abgelaufen ist oder nicht mehr über den öffentlichen Async-Task-Vertrag aufgelöst werden kann, gibt TokenLab Folgendes zurück:
