...
<ResponseField name="progress" type="number">
  Fortschritt in Prozent, wenn verfügbar.
</ResponseField>
...
<ResponseField name="created" type="integer">
  Erstellungszeitstempel, falls verfügbar.
</ResponseField>

<ResponseField name="updated" type="integer">
  Zeitstempel der letzten Aktualisierung, falls verfügbar.
</ResponseField>

<ResponseField name="model" type="string">
  Verwendetes Modell, falls verfügbar.
</ResponseField>
