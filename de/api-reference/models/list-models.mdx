...
<ResponseField name="data" type="array">
  ...
  - `tokenlab.request_format_summary` (object oder `null`): Leichte Discovery-Zusammenfassung mit `public_operations`, `request_endpoint` und `request_endpoint_by_operation`
