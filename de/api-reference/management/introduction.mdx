...
| limitAmount | number \| null | min. 0, max. 100000 | null bedeutet unbegrenzt, 0 bedeutet kein nutzbares Budget |
| models | string[] | - | Aktualisierte Allowlist für logische Modelle |
| expiresAt | string \| null | RFC3339-Datetime | null entfernt ein vorhandenes Ablaufdatum |
