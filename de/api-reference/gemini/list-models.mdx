...
<ParamField query="pageToken" type="string">
  Undurchsichtiger Fortsetzungstoken aus einer vorherigen Seite. Gib ihn unverändert zurück, um die nächste Seite abzurufen.
</ParamField>

## Authentifizierung

Optional. Unterstützt dieselben Authentifizierungsmethoden wie andere Gemini-Endpunkte:
...
<ResponseField name="nextPageToken" type="string">
  Wird zurückgegeben, wenn weitere Modelle vorhanden sind. Übergib diesen Wert als `pageToken`, um die Pagination fortzusetzen.
</ResponseField>
