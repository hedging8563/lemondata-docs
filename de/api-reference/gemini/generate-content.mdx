...
<ParamField path="model" type="string" required>
  ...
  TokenLab leitet unterstützte Gemini-native Kanäle nach Möglichkeit über den nativen Pfad und fällt automatisch auf den kompatiblen internen Konvertierungspfad zurück, wenn für diese multimodale Anfrage keine native Route verfügbar ist.
...
<ParamField body="contents" type="array" required>
  ...
  Für Medien-Parts akzeptiert TokenLab derzeit Bild-, Audio- und Video-MIME-Typen und leitet sie über den Gemini-kompatiblen Public Contract weiter.
