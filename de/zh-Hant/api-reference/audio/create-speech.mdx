...
description: "Generiert Audio basierend auf dem Eingabetext"
---

## Anfrage-Body

<ParamField body="model" type="string" default="tts-1">
  TTS-Modell: `tts-1` (Standard) oder `tts-1-hd` (hohe Qualität).
</ParamField>

<ParamField body="input" type="string" required>
  Der Text, aus dem Audio generiert werden soll. Maximal 4096 Zeichen.
</ParamField>

<ParamField body="voice" type="string" required>
  Die zu verwendende Stimme: `alloy`, `ash`, `ballad`, `coral`, `echo`, `fable`, `nova`, `onyx`, `sage`, `shimmer`, `verse`.
</ParamField>
...
| `fable` | Ausdrucksstark, narrativ |
| `nova` | Freundlich, klar |
| `onyx` | Tief, autoritär |
| `sage` | Weise, bedacht |
| `shimmer` | Sanft, behutsam |
