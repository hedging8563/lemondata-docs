---
title: "Musikstatus abrufen"
openapi: "GET /v1/music/generations/{id}"
description: "Status und Ergebnisse eines Musikgenerierungs-Tasks abrufen"
---

Fragen Sie diesen Endpunkt ab, um den Status eines Musikgenerierungs-Tasks zu überprüfen.

## Pfadparameter

<ParamField path="id" type="string" required>
  ID des Musikgenerierungs-Tasks.
</ParamField>
...
<ResponseField name="audio_url" type="string">
  Download-Link für die Audiodatei (bei Abschluss).
</ResponseField>

<ResponseField name="video_url" type="string">
  Link zur Videoversion mit Visualisierungseffekten (bei Abschluss).
</ResponseField>
