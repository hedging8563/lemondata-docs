---
title: "3D-Modellstatus abrufen"
openapi: "GET /v1/3d/generations/{id}"
description: "Status und Ergebnisse einer 3D-Generierungsaufgabe abrufen"
---

Fragen Sie diesen Endpunkt ab, um den Status Ihrer 3D-Modellgenerierungsaufgabe zu überprüfen.

## Pfadparameter

<ParamField path="id" type="string" required>
  ID der 3D-Generierungsaufgabe.
</ParamField>
...
<ResponseField name="model_url" type="string">
  URL zum Herunterladen der 3D-Modelldatei (bei Abschluss).
</ResponseField>

<ResponseField name="glb_url" type="string">
  URL zum Herunterladen des Modells im GLB-Format (falls verfügbar).
</ResponseField>

<ResponseField name="fbx_url" type="string">
  URL zum Herunterladen des Modells im FBX-Format (falls verfügbar).
</ResponseField>

<ResponseField name="error" type="string">
  Fehlermeldung (bei Fehlgeschlagen).
</ResponseField>
