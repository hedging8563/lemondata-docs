---
title: "Streaming von generierten Inhalten"
openapi: "POST /v1beta/models/{model}:streamGenerateContent"
description: "Streaming von generierten Inhalten im Google Gemini API-Format"
---

Die Streaming-Version des Gemini `generateContent`-Endpunkts. Gibt Server-Sent Events zurück.
...
Identisch mit [Inhalt generieren](/api-reference/gemini/generate-content).

## Antwort

Gibt einen Stream von JSON-Objekten zurück, wobei jedes Objekt eine Teilantwort enthält.
