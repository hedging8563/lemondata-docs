...
description: "Status und Ergebnis einer Videogenerierungsaufgabe abrufen"
---

## Pfadparameter

<ParamField path="task_id" type="string" required>
  Die Aufgaben-ID, die bei der Erstellung der Videoanfrage zurückgegeben wurde.
</ParamField>
...
<ResponseField name="status" type="string">
  Aufgabenstatus: `pending`, `processing`, `completed`, `failed`.
</ResponseField>
...
<ResponseField name="video_url" type="string">
  URL des generierten Videos (bei Abschluss).
</ResponseField>
...
<ResponseField name="completed_at" type="integer">
  Zeitstempel des Abschlusses (bei Abschluss).
</ResponseField>
...
- Führen Sie alle 5-10 Sekunden ein Polling durch
- Implementieren Sie einen exponentiellen Backoff (exponential backoff) für zeitintensive Aufgaben
- Legen Sie ein maximales Timeout fest (z. B. 10 Minuten)
- Behandeln Sie den `failed` Status ordnungsgemäß
