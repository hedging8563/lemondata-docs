---
title: "Streaming"
description: "Implementierung von Echtzeit-Streaming-Antworten"
---

## Übersicht

Streaming ermöglicht es Ihnen, Teile des Inhalts in Echtzeit zu empfangen, während die Antwort generiert wird, was eine bessere Benutzererfahrung für Chat-Anwendungen bietet.

## Streaming aktivieren

Setzen Sie in Ihrer Anfrage `stream: true`:
...
## Ende des Streams verarbeiten

Der Stream endet bei:
- `finish_reason: "stop"` - Normaler Abschluss
- `finish_reason: "length"` - `max_tokens` Limit erreicht
- `finish_reason: "tool_calls"` - Modell möchte Tools aufrufen
- `data: [DONE]` - Letzte Nachricht

## Vollständige Antwort erfassen

Um die vollständige Antwort während des Streamings zu erfassen:
...
## Asynchrones Streaming (Async Streaming)
