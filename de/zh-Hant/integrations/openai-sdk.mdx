---
title: "OpenAI SDK"
description: "Nutzen Sie LemonData über das offizielle OpenAI SDK"
---

## Übersicht

LemonData ist vollständig kompatibel mit dem OpenAI SDK. Ändern Sie einfach die `base URL`, um auf über 300 Modelle zuzugreifen.
...
Der Hauptvorteil von LemonData liegt im Zugriff auf mehrere Anbieter:
