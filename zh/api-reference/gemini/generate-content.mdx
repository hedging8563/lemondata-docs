...
I'm now satisfied with the translation of the sample content, and I've carefully checked all the rules. It's time to translate the main documentation, focusing on accuracy and consistency. I am also updating the style of translations for better readability.
