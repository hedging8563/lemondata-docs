...
本页是 request-side cache 指南。

如需严格的 API 参考页面，请参见：

- [提交缓存反馈](/zh/api-reference/cache/submit-cache-feedback)
- [获取缓存反馈统计](/zh/api-reference/cache/get-cache-feedback-stats)
...
请使用当前组织下缓存命中的 request/cache entry 标识；任意 ID 会被拒绝。
