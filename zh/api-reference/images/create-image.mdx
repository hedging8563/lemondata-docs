...
<ParamField body="resolution" type="string">
  ...
  支持于 `gemini-3-pro-image-preview`、`nano-banana-pro`、`nano-banana-2` 以及类似的高分辨率家族。常见值为 `1k`、`2k`、`4k`。除非模型明确说明，否则不要发送给 Gemini Flash 图片家族。xAI Grok Imagine 图片模型请使用 `1k` 或 `2k`。
</ParamField>
