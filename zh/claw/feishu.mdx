<think>**Refining the Translation**
</think>
...
<Steps>
  ...
  <Step title="获取凭据">
    ...
    3. 复制 **App Secret**
  <think>**Revisiting Terminology and Labels**
</think>
  ...
  <Step title="配置事件订阅">
    ...
    <Tip>
    当您在 LemonData 控制台中配置飞书时，**Encrypt Key** 和 **Verification Token** 会为您自动生成。将这些值复制到飞书开发者后台。
    </Tip>
  </Step>
  <Step title="添加事件权限">
    1. 在事件订阅下，添加以下事件：
...
在控制台的 **IM Integrations** 选项卡中配置群聊行为：
