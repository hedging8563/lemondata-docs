---
title: "自托管安装"
description: "在您自己的服务器上运行 LemonClaw，接入 LemonData AI API — 一条命令，无需 Docker"
---

<Note>
**自托管**意味着您直接在自己的 VPS 或机器上运行 LemonClaw。您只需通过 LemonData 余额支付 AI 模型使用费用 — 无实例费用。
</Note>
...
<Steps>
  ...
  <Step title="LemonClaw">
    来自 npm 的官方 LemonClaw 包，已预配置 LemonData API
  </Step>
