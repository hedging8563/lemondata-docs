<think>**Focusing Translation Objectives**
**Refining Translation Rules**
**Structuring Translation Outputs**
**Implementing Language Consistency**
**Expanding Translation Coverage**
**Consolidating Translation Strategies**
</think>
...
<ParamField body="defaultModel" type="string">
  默认 AI 模型（例如：`claude-opus-4-6`、`gpt-5.2`、`gemini-3-pro-preview`、`minimax-m2.1`、`kimi-k2.5`）
</ParamField>
...
在保留数据 (PVC) 的同时销毁并重新创建容器。限制为**每天 10 次重建**。
