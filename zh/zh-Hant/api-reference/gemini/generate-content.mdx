...
LemonData 支持 Gemini 模型的原生 Google Gemini API 格式。这使得与 Google AI SDK 具有直接的兼容性。
...
- `x-goog-api-key: YOUR_API_KEY` 标头
- `Authorization: Bearer YOUR_API_KEY` 标头
