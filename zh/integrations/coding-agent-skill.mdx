...
description: "为任意编码代理安装共享的 LemonData API 集成技能，并具备 Agent-First 错误恢复能力。"
---

<Note>
这个技能会教你的编码代理只需通过描述需求，就能集成 LemonData 的 **数百个 AI API**。它被打包为一个共享的 Agent-First 技能，并适用于任何支持 skill 或 rules 文件的编码代理。
