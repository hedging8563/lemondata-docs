...
const translations = {
  zh: {
    ...
    groups: { 'Getting Started': '快速入门', 'Guides': '指南', 'Overview': '概览', 'Chat': '对话', 'Messages': '消息', 'Responses': '响应', 'Gemini': 'Gemini', 'Images': '图像', 'Video': '视频', 'Audio': '音频', 'Music': '音乐', '3D': '3D', 'Embeddings': '向量嵌入', 'Rerank': '重排序', 'Cache': '缓存', 'Models': '模型', 'Pricing': '定价', 'Chat Platforms': '聊天平台', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': '框架', 'Chat Apps': '聊天应用' }
  },
  'zh-Hant': {
    tabs: { 'Documentation': '文件', 'API Reference': 'API 參考', 'Claw': 'Claw', 'Integrations': '整合' },
    groups: { 'Getting Started': '快速入門', 'Guides': '指南', 'Overview': '概覽', 'Chat': '對話', 'Messages': '訊息', 'Responses': '回應', 'Gemini': 'Gemini', 'Images': '圖像', 'Video': '影片', 'Audio': '音訊', 'Music': '音樂', '3D': '3D', 'Embeddings': '向量嵌入', 'Rerank': '重新排序', 'Cache': '快取', 'Models': '模型', 'Pricing': '定價', 'Chat Platforms': '聊天平台', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': '框架', 'Chat Apps': '聊天應用' }
  },
  ja: {
    tabs: { 'Documentation': 'ドキュメント', 'API Reference': 'APIリファレンス', 'Claw': 'Claw', 'Integrations': '連携' },
    groups: { 'Getting Started': 'はじめに', 'Guides': 'ガイド', 'Overview': '概要', 'Chat': 'チャット', 'Messages': 'メッセージ', 'Responses': 'レスポンス', 'Gemini': 'Gemini', 'Images': '画像', 'Video': '動画', 'Audio': '音声', 'Music': '音楽', '3D': '3D', 'Embeddings': 'エンベディング', 'Rerank': 'リランク', 'Cache': 'キャッシュ', 'Models': 'モデル', 'Pricing': '料金', 'Chat Platforms': 'チャットプラットフォーム', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'フレームワーク', 'Chat Apps': 'チャットアプリ' }
  },
  ko: {
    tabs: { 'Documentation': '문서', 'API Reference': 'API 레퍼런스', 'Claw': 'Claw', 'Integrations': '통합' },
    groups: { 'Getting Started': '시작하기', 'Guides': '가이드', 'Overview': '개요', 'Chat': '채팅', 'Messages': '메시지', 'Responses': '응답', 'Gemini': 'Gemini', 'Images': '이미지', 'Video': '비디오', 'Audio': '오디오', 'Music': '음악', '3D': '3D', 'Embeddings': '임베딩', 'Rerank': '리랭크', 'Cache': '캐시', 'Models': '모델', 'Pricing': '요금', 'Chat Platforms': '채팅 플랫폼', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': '프레임워크', 'Chat Apps': '채팅 앱' }
  },
  de: {
    tabs: { 'Documentation': 'Dokumentation', 'API Reference': 'API-Referenz', 'Claw': 'Claw', 'Integrations': 'Integrationen' },
    groups: { 'Getting Started': 'Erste Schritte', 'Guides': 'Anleitungen', 'Overview': 'Übersicht', 'Chat': 'Chat', 'Messages': 'Nachrichten', 'Responses': 'Antworten', 'Gemini': 'Gemini', 'Images': 'Bilder', 'Video': 'Video', 'Audio': 'Audio', 'Music': 'Musik', '3D': '3D', 'Embeddings': 'Embeddings', 'Rerank': 'Rerank', 'Cache': 'Cache', 'Models': 'Modelle', 'Pricing': 'Preise', 'Chat Platforms': 'Chat-Plattformen', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'Frameworks', 'Chat Apps': 'Chat-Apps' }
  },
  fr: {
    tabs: { 'Documentation': 'Documentation', 'API Reference': 'Référence API', 'Claw': 'Claw', 'Integrations': 'Intégrations' },
    groups: { 'Getting Started': 'Démarrage', 'Guides': 'Guides', 'Overview': 'Aperçu', 'Chat': 'Chat', 'Messages': 'Messages', 'Responses': 'Réponses', 'Gemini': 'Gemini', 'Images': 'Images', 'Video': 'Vidéo', 'Audio': 'Audio', 'Music': 'Musique', '3D': '3D', 'Embeddings': 'Embeddings', 'Rerank': 'Rerank', 'Cache': 'Cache', 'Models': 'Modèles', 'Pricing': 'Tarifs', 'Chat Platforms': 'Plateformes de chat', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'Frameworks', 'Chat Apps': 'Apps de chat' }
  },
  es: {
    tabs: { 'Documentation': 'Documentación', 'API Reference': 'Referencia API', 'Claw': 'Claw', 'Integrations': 'Integraciones' },
    groups: { 'Getting Started': 'Primeros pasos', 'Guides': 'Guías', 'Overview': 'Descripción general', 'Chat': 'Chat', 'Messages': 'Mensajes', 'Responses': 'Respuestas', 'Gemini': 'Gemini', 'Images': 'Imágenes', 'Video': 'Video', 'Audio': 'Audio', 'Music': 'Música', '3D': '3D', 'Embeddings': 'Embeddings', 'Rerank': 'Rerank', 'Cache': 'Caché', 'Models': 'Modelos', 'Pricing': 'Precios', 'Chat Platforms': 'Plataformas de chat', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'Frameworks', 'Chat Apps': 'Apps de chat' }
  },
  pt: {
    tabs: { 'Documentation': 'Documentação', 'API Reference': 'Referência da API', 'Claw': 'Claw', 'Integrations': 'Integrações' },
    groups: { 'Getting Started': 'Primeiros passos', 'Guides': 'Guias', 'Overview': 'Visão geral', 'Chat': 'Chat', 'Messages': 'Mensagens', 'Responses': 'Respostas', 'Gemini': 'Gemini', 'Images': 'Imagens', 'Video': 'Vídeo', 'Audio': 'Áudio', 'Music': 'Música', '3D': '3D', 'Embeddings': 'Embeddings', 'Rerank': 'Rerank', 'Cache': 'Cache', 'Models': 'Modelos', 'Pricing': 'Preços', 'Chat Platforms': 'Plataformas de chat', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'Frameworks', 'Chat Apps': 'Apps de chat' }
  },
  ar: {
    tabs: { 'Documentation': 'التوثيق', 'API Reference': 'مرجع API', 'Claw': 'Claw', 'Integrations': 'التكاملات' },
    groups: { 'Getting Started': 'البدء', 'Guides': 'الأدلة', 'Overview': 'نظرة عامة', 'Chat': 'الدردشة', 'Messages': 'الرسائل', 'Responses': 'الاستجابات', 'Gemini': 'Gemini', 'Images': 'الصور', 'Video': 'الفيديو', 'Audio': 'الصوت', 'Music': 'الموسيقى', '3D': '3D', 'Embeddings': 'التضمينات', 'Rerank': 'إعادة الترتيب', 'Cache': 'التخزين المؤقت', 'Models': 'النماذج', 'Pricing': 'الأسعار', 'Chat Platforms': 'منصات الدردشة', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'أطر العمل', 'Chat Apps': 'تطبيقات الدردشة' }
  },
  vi: {
    tabs: { 'Documentation': 'Tài liệu', 'API Reference': 'Tham chiếu API', 'Claw': 'Claw', 'Integrations': 'Tích hợp' },
    groups: { 'Getting Started': 'Bắt đầu', 'Guides': 'Hướng dẫn', 'Overview': 'Tổng quan', 'Chat': 'Chat', 'Messages': 'Tin nhắn', 'Responses': 'Phản hồi', 'Gemini': 'Gemini', 'Images': 'Hình ảnh', 'Video': 'Video', 'Audio': 'Âm thanh', 'Music': 'Âm nhạc', '3D': '3D', 'Embeddings': 'Embeddings', 'Rerank': 'Rerank', 'Cache': 'Bộ nhớ đệm', 'Models': 'Mô hình', 'Pricing': 'Bảng giá', 'Chat Platforms': 'Nền tảng chat', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'Frameworks', 'Chat Apps': 'Ứng dụng chat' }
  },
  id: {
    tabs: { 'Documentation': 'Dokumentasi', 'API Reference': 'Referensi API', 'Claw': 'Claw', 'Integrations': 'Integrasi' },
    groups: { 'Getting Started': 'Memulai', 'Guides': 'Panduan', 'Overview': 'Ikhtisar', 'Chat': 'Chat', 'Messages': 'Pesan', 'Responses': 'Respons', 'Gemini': 'Gemini', 'Images': 'Gambar', 'Video': 'Video', 'Audio': 'Audio', 'Music': 'Musik', '3D': '3D', 'Embeddings': 'Embeddings', 'Rerank': 'Rerank', 'Cache': 'Cache', 'Models': 'Model', 'Pricing': 'Harga', 'Chat Platforms': 'Platform Chat', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'Frameworks', 'Chat Apps': 'Aplikasi Chat' }
  },
  tr: {
    tabs: { 'Documentation': 'Dokümantasyon', 'API Reference': 'API Referansı', 'Claw': 'Claw', 'Integrations': 'Entegrasyonlar' },
    groups: { 'Getting Started': 'Başlarken', 'Guides': 'Kılavuzlar', 'Overview': 'Genel Bakış', 'Chat': 'Sohbet', 'Messages': 'Mesajlar', 'Responses': 'Yanıtlar', 'Gemini': 'Gemini', 'Images': 'Görseller', 'Video': 'Video', 'Audio': 'Ses', 'Music': 'Müzik', '3D': '3D', 'Embeddings': 'Embeddings', 'Rerank': 'Rerank', 'Cache': 'Önbellek', 'Models': 'Modeller', 'Pricing': 'Fiyatlandırma', 'Chat Platforms': 'Sohbet Platformları', 'IDE & CLI': 'IDE & CLI', 'SDKs': 'SDKs', 'Frameworks': 'Frameworks', 'Chat Apps': 'Sohbet Uygulamaları' }
  },
};
