...
| `cache_pricing` | object or `null` | Model-specific upstream prompt cache prices. Pure platform semantic-cache discount no longer appears by itself on the list route. |
