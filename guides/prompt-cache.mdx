...
In addition to TokenLab's [platform semantic cache](/guides/caching), many AI providers offer their own **prompt caching** feature. This is a separate caching mechanism that operates at the provider level (Anthropic, OpenAI, DeepSeek, etc.).
...
|------|-------|--------------|------|
| **Platform Cache** | TokenLab | Semantic similarity matching | 10% of normal price |
...
<Info>
Discounts are applied automatically. TokenLab passes through the provider's cache pricing to you.
</Info>
