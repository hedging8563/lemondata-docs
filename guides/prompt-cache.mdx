...
|------|-------|--------------|------|
| **Platform Cache** | LemonData | Semantic similarity matching | Free (no API call) |
...
- **Cache** (sky blue): Platform semantic cache hit - zero cost
...
| **Cost** | Free (no API call) | Discounted rates |
