...
|------|-------|--------------|------|
| **Platform Cache** | LemonData | Semantic similarity matching | 20% of normal price |
...
- **Cache** (sky blue): Platform semantic cache hit - 80% discount
...
| **Cost** | 20% of normal price | Discounted rates |
