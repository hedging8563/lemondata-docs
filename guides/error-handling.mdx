...
|------|------|-------------|
| `invalid_request_error` | `invalid_api_key` | API key is missing or invalid |
| `invalid_request_error` | `expired_api_key` | API key has been revoked |
...
| Type | Code | Description |
|------|------|-------------|
| `insufficient_quota` | `insufficient_balance` | Account balance is too low |
| `insufficient_quota` | `quota_exceeded` | API key usage limit reached |
