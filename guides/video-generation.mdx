...
For Seedance 2.0, image URLs and supported inline data URLs are automatically prepared as reusable TokenLab materials before generation; if preparation takes longer than 60 seconds, retry after the returned `auto_material_asset_ids` become `ACTIVE`.
