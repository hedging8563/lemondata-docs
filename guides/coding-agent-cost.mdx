...
LemonData's [semantic cache](/guides/caching) matches requests by meaning, not exact text. This is powerful for coding agents because:
...
[Upstream prompt caching](/guides/prompt-cache) is automatic through LemonData. Long system prompts — which coding agents always include — get cached at the provider level:
