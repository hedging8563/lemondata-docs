...
For new OpenAI-style integrations, prefer **Responses streaming** first. If your framework still uses Chat Completions streaming, LemonData supports that compatibility path too.
