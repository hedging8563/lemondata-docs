---
title: "OpenAI SDK"
description: "Gunakan LemonData melalui OpenAI SDK resmi"
---

## Ikhtisar

LemonData sepenuhnya kompatibel dengan OpenAI SDK. Cukup ubah base URL untuk mengakses lebih dari 300 model.
...
Cara kerjanya sama persis dengan OpenAI API:
...
## Audio - Transkripsi (Transcription)
...
Keunggulan utama LemonData adalah kemampuan untuk mengakses berbagai penyedia:
