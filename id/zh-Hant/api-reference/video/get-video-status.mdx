...
description: "Dapatkan status dan hasil dari tugas pembuatan video"
---
...
<ResponseField name="video_url" type="string">
  URL video yang dihasilkan (saat selesai).
</ResponseField>
...
- Terapkan exponential backoff untuk tugas yang memakan waktu lama
- Atur batas waktu (timeout) maksimum (misalnya 10 menit)
- Tangani status `failed` dengan benar
