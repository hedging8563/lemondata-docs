...
description: "Buat tugas pembuatan video"
---

## Ikhtisar

Pembuatan video bersifat asinkron. Anda mengirimkan permintaan dan menerima sebuah `task_id`, kemudian melakukan polling untuk hasilnya.
...
<ParamField body="prompt" type="string" required>
  Deskripsi teks video yang akan dibuat.
</ParamField>

<ParamField body="image_url" type="string">
  Gambar awal opsional untuk pembuatan video dari gambar (image-to-video).
</ParamField>

<ParamField body="duration" type="integer">
  Durasi video dalam detik (tergantung pada model).
</ParamField>
...
<ParamField body="negative_prompt" type="string">
  Konten yang harus dihindari dalam pembuatan video.
</ParamField>

<ParamField body="seed" type="integer">
  Seed acak untuk pembuatan yang dapat diulang.
</ParamField>

<ParamField body="cfg_scale" type="number">
  Skala panduan tanpa klasifikasi (0-20).
</ParamField>

<ParamField body="motion_strength" type="number">
  Kekuatan gerakan (0-1).
</ParamField>
...
<ResponseField name="task_id" type="string">
  Pengidentifikasi tugas unik yang digunakan untuk polling.
</ResponseField>
...
| `veo3.1` | T2V | Model terbaru dari Google |
| `veo3.1-pro` | T2V | Kualitas tingkat profesional |
