...
description: "Dapatkan status dan hasil dari tugas pembuatan musik"
---

Lakukan polling pada endpoint ini untuk memeriksa status tugas pembuatan musik.
...
<ResponseField name="audio_url" type="string">
  Tautan unduhan file audio (saat selesai).
</ResponseField>

<ResponseField name="video_url" type="string">
  Tautan versi video dengan efek visualisasi (saat selesai).
</ResponseField>
