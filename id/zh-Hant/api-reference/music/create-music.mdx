...
description: "Buat tugas pembuatan musik menggunakan Suno"
---

Gunakan AI untuk menghasilkan musik dan lirik. Ini adalah API asinkron - Anda akan menerima ID tugas untuk melakukan polling status penyelesaian.

## Parameter Permintaan

<ParamField body="model" type="string" default="suno_music">
  Model yang akan digunakan: `suno_music` untuk pembuatan musik, `suno_lyrics` hanya untuk lirik.
</ParamField>
...
<ParamField body="mv" type="string">
  Versi model yang akan digunakan.
</ParamField>
...
<ParamField body="continue_at" type="number">
  Timestamp untuk melanjutkan (dalam detik).
</ParamField>

<ParamField body="user" type="string">
  Identifier unik untuk pengguna akhir.
</ParamField>
