---
title: "Membuat Embedding"
openapi: "POST /v1/embeddings"
description: "Membuat vektor embedding yang mewakili teks input"
---

## Request Body

<ParamField body="model" type="string" required>
  ID model embedding yang akan digunakan (contoh: `text-embedding-3-small`).
</ParamField>
...
<ParamField body="encoding_format" type="string" default="float">
  Format embedding: `float` atau `base64`.
</ParamField>

<ParamField body="dimensions" type="integer">
  Jumlah dimensi output (tergantung pada model tertentu).
</ParamField>

<ParamField body="user" type="string">
  ID unik yang mewakili pengguna akhir Anda, digunakan untuk pemantauan penyalahgunaan.
</ParamField>
...
| `text-embedding-ada-002` | 1536 | Versi lama |
...
<ResponseField name="usage" type="object">
  Penggunaan token yang mencakup `prompt_tokens` dan `total_tokens`.
</ResponseField>
