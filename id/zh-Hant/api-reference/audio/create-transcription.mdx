...
<ParamField body="file" type="file" required>
  File audio yang akan ditranskripsi. Format yang didukung: flac, mp3, mp4, mpeg, mpga, m4a, ogg, wav, webm.
</ParamField>
...
<ParamField body="language" type="string">
  Bahasa dari audio, dalam format ISO-639-1 (contoh: `en`, `zh`, `ja`).
</ParamField>

<ParamField body="prompt" type="string">
  Teks opsional untuk memandu gaya model atau melanjutkan potongan sebelumnya.
</ParamField>
...
<ParamField body="temperature" type="number" default="0">
  Temperature sampling (0 hingga 1).
</ParamField>
...
<ResponseField name="segments" type="array">
  Segmen transkripsi yang menyertakan timestamp.
</ResponseField>
...
Untuk menerjemahkan audio ke dalam bahasa Inggris, gunakan endpoint terjemahan:
