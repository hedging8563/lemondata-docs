...
description: "Menghasilkan audio berdasarkan teks input"
---

## Request Body

<ParamField body="model" type="string" default="tts-1">
  Model TTS: `tts-1` (standar) atau `tts-1-hd` (kualitas tinggi).
</ParamField>

<ParamField body="input" type="string" required>
  Teks untuk menghasilkan audio. Maksimal 4096 karakter.
</ParamField>
