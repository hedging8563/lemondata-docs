...
description: "Dapatkan status dan hasil dari tugas pembuatan 3D"
---
...
<ResponseField name="glb_url" type="string">
  URL untuk mengunduh model format GLB (jika tersedia).
</ResponseField>

<ResponseField name="fbx_url" type="string">
  URL untuk mengunduh model format FBX (jika tersedia).
</ResponseField>
