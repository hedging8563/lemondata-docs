---
title: "Ambil Konten File"
openapi: "GET /v1/files/{file_id}/content"
description: "Mengunduh konten JSONL asli untuk file batch."
---

## Ikhtisar

Endpoint ini adalah bagian dari Batch API yang kompatibel dengan OpenAI dari LemonData. Pekerjaan batch menggunakan file JSONL yang diunggah, dijalankan secara asinkron, dan dapat mengembalikan file output/error nanti.
