...
Model yang didukung adalah `marble-1.0`, `marble-1.1`, dan `marble-1.1-plus`. World Labs mendokumentasikan `marble-1.0-draft`, tetapi TokenLab belum mengekspos draft generation di endpoint ini.
...
Endpoint ini mencakup world generation dan polling. TokenLab saat ini tidak mem-proxy upload media asset World Labs, daftar world, penghapusan world, atau alat pano mandiri.
