...
<ResponseField name="lemondata" type="object">
  Metadata publik khusus TokenLab. Route detail dapat mencakup `category`, `pricing_unit`, `capability_flags`, `supported_operations`, `pricing_provenance`, `public_contract_summary`, `public_contract` lengkap, dan `agent_preferences` level scene untuk snapshot rekomendasi non-chat.
</ResponseField>
