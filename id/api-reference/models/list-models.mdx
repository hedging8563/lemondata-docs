...
<ResponseField name="data" type="array">
  ...
  - `tokenlab.request_format_summary` (object atau `null`): Ringkasan discovery non-chat ringan yang berisi `public_operations`, `request_endpoint`, dan `request_endpoint_by_operation`
