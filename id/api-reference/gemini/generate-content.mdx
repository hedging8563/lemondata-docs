...
<ParamField path="model" type="string" required>
  ...
  TokenLab akan mengarahkan kanal native Gemini yang didukung melalui jalur native jika memungkinkan dan secara otomatis beralih ke jalur konversi internal yang kompatibel ketika rute yang siap-native tidak tersedia untuk permintaan multimodal tersebut.
...
<ParamField body="contents" type="array" required>
  ...
  Untuk bagian media, TokenLab saat ini menerima MIME type gambar, audio, dan video lalu meneruskannya melalui kontrak publik yang kompatibel dengan Gemini.
