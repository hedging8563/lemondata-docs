...
<ParamField body="image" type="file" required>
  Gambar yang ingin diedit. Harus PNG yang valid, kurang dari 4MB, dan berbentuk persegi. Gambar harus memiliki transparansi di area yang ingin diedit.
</ParamField>
...
<ParamField body="mask" type="file">
  Gambar tambahan dengan area yang benar-benar transparan untuk menunjukkan di mana gambar harus diedit. Harus PNG yang valid, kurang dari 4MB, dan memiliki dimensi yang sama dengan `image`.
</ParamField>
