...
<ParamField body="size" type="string" default="1024x1024">
  Ukuran gambar. Gunakan untuk keluarga model gaya OpenAI dan model lain yang menerima ukuran piksel pasti.

  Untuk keluarga gambar Google Gemini, `size` diperlakukan sebagai alias kompatibilitas yang memetakan ke kontrak publik `aspect_ratio` model dan, bila didukung, `resolution`. Untuk model-model itu, lebih baik kirim `aspect_ratio` secara langsung.
</ParamField>
