...
Catatan kompatibilitas: jika permintaan `gpt-image-2` mengirim `input_fidelity`, LemonData menghapus kolom itu sebelum meneruskan karena GPT Image 2 sudah otomatis memproses input gambar dengan fidelitas tinggi.
