...
<ParamField body="resolution" type="string">
  ...
  Didukung pada `gemini-3-pro-image-preview`, `nano-banana-pro`, `nano-banana-2`, dan keluarga resolusi tinggi serupa. Nilai tipikal adalah `1k`, `2k`, dan `4k`. Jangan kirim parameter ini ke keluarga Gemini Flash image kecuali modelnya mendokumentasikannya secara eksplisit. Untuk model gambar xAI Grok Imagine, gunakan `1k` atau `2k`.
</ParamField>
