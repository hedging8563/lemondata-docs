...
<ParamField body="material_asset_id" type="string">
  ID material Seedance TokenLab yang dikembalikan oleh [Create Material Asset](/id/api-reference/video/create-material-asset) atau persiapan gambar otomatis. Gunakan setelah material menjadi `ACTIVE` dengan model Seedance yang dapat menggunakan pustaka material TokenLab.
</ParamField>
