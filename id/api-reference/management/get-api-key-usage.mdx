...
- Semua field moneter tetap tersedia dalam USD dan kini juga memiliki padanan tampilan RMB seperti `cost_cny`, `total_cost_cny`, dan `cost_cny` di setiap breakdown.
