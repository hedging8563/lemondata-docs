...
Endpoint ini mengembalikan agregat billing berbasis konsumsi untuk API key yang dipilih, termasuk total biaya, total request, usage per unit penagihan, serta breakdown berdasarkan nama model yang dikirim di permintaan (`model`), penyedia, `scene`, ``, kelas cache, dan tren biaya harian.
