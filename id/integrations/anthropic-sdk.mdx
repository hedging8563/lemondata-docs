---
title: "Anthropic SDK"
description: "Gunakan LemonData dengan Anthropic SDK untuk kompatibilitas Messages API native Claude"
---
...
LemonData mendukung path native Anthropic **Messages API**, sehingga Anda dapat menggunakan Anthropic SDK resmi secara langsung untuk model Claude.

<Note>
Untuk Anthropic SDK, gunakan `https://api.lemondata.cc` sebagai base URL, tanpa menambahkan `/v1` sendiri.
</Note>

Di antara rute SDK yang didokumentasikan, ini adalah salah satu jalur LemonData yang paling didukung untuk fitur native Claude.
...
<AccordionGroup>
  ...
  <Accordion title="Autentikasi Gagal">
    - Periksa bahwa LemonData API key Anda diawali dengan `sk-`
