---
title: "OpenAI SDK"
description: "Gunakan LemonData dengan SDK resmi OpenAI dan klien yang kompatibel dengan OpenAI"
---

## Ringkasan

LemonData bekerja dengan SDK resmi OpenAI dengan mengarahkan klien ke `https://api.lemondata.cc/v1`.
