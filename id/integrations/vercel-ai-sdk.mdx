---
title: "Vercel AI SDK"
description: "Integrasikan LemonData dengan Vercel AI SDK menggunakan penyedia yang kompatibel dengan OpenAI atau jalur Responses native"
---

## Gambaran Umum

Untuk LemonData, default yang paling stabil di Vercel AI SDK adalah **penyedia yang kompatibel dengan OpenAI**.

Jika Anda secara khusus memerlukan perilaku **Responses native**, Anda dapat beralih ke penyedia OpenAI dan tetap menggunakan URL dasar LemonData yang sama.
...
<AccordionGroup>
  ...
  <Accordion title="Simpan rahasia di server">
    Jangan pernah mengekspos LemonData API key Anda dalam kode sisi client. Tempatkan setup penyedia di file server atau route API.
  </Accordion>
</AccordionGroup>
