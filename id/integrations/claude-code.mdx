...
<Note>
Untuk LemonData, pertahankan `ANTHROPIC_BASE_URL` pada `https://api.tokenlab.sh` tanpa sufiks `/v1`. Ini sesuai dengan bentuk endpoint bergaya Anthropic dan pola gateway terpadu yang didokumentasikan oleh Claude Code.
</Note>
