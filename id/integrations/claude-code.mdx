...
Anthropic sekarang merekomendasikan installer native. Instalasi npm masih tersedia demi kompatibilitas, tetapi sudah deprecated di upstream.

```bash
curl -fsSL https://claude.ai/install.sh | bash
```

Jika Anda benar-benar membutuhkan paket npm, gunakan:
