---
title: "LangChain"
description: "Integrasikan LemonData dengan LangChain menggunakan chat dan embeddings standar yang kompatibel dengan OpenAI"
---
...
<AccordionGroup>
  <Accordion title="Teruskan base_url secara eksplisit">
    Setup LemonData yang paling andal adalah meneruskan `base_url="https://api.tokenlab.sh/v1"` secara langsung ke `ChatOpenAI` dan `OpenAIEmbeddings` alih-alih bergantung pada alias environment variable yang lebih lama.
  </Accordion>
