...
<CardGroup cols={2}>
  <Card title="Instal di Cursor" icon="arrow-pointer" href="https://cursor.com/en/install-mcp?name=tokenlab-model-catalog&config=eyJ0eXBlIjoic3RkaW8iLCJjb21tYW5kIjoibnB4IiwiYXJncyI6WyIteSIsIkB0b2tlbmxhYmFpL21jcC1zZXJ2ZXIiXSwiZW52Ijp7IlRPS0VOTEFCX01DUF9UT09MX1BST0ZJTEUiOiJjYXRhbG9nIn19">
    Tambahkan profil publik `catalog` ke Cursor dengan sekali klik
  </Card>
  <Card title="Instal di VS Code" icon="code" href="https://vscode.dev/redirect/mcp/install?name=tokenlab-model-catalog&config=%7B%22type%22%3A%22stdio%22%2C%22command%22%3A%22npx%22%2C%22args%22%3A%5B%22-y%22%2C%22%40tokenlabai%2Fmcp-server%22%5D%2C%22env%22%3A%7B%22TOKENLAB_MCP_TOOL_PROFILE%22%3A%22catalog%22%7D%7D">
...
Pada klien stdio lokal, gunakan nama `tokenlab-model-catalog`, perintah `npx`, argumen terpisah `-y` dan `@tokenlabai/mcp-server`, serta biarkan direktori kerja kosong. Gunakan `@tokenlabai/mcp-server@0.6.17` untuk mengunci rilis yang saat ini telah diverifikasi.
