---
title: "Feishu / Lark"
description: "Hubungkan instansi Claw Anda ke Feishu (Lark) menggunakan event WebSocket"
---

Hubungkan Feishu (飞书) atau Lark ke instansi Claw Anda. Menggunakan mode WebSocket — tidak memerlukan URL callback publik.
...
<Steps>
  ...
  <Step title="Konfigurasi di Dashboard LemonData">
    ...
    6. Salin **Encrypt Key** dan **Verification Token** yang dihasilkan secara otomatis kembali ke konsol pengembang Feishu
    7. Klik **Save**
  </Step>
...
<AccordionGroup>
  <Accordion title="Bot tidak menerima pesan">
    ...
    - Periksa apakah event `im.message.receive_v1` telah dilanggan
