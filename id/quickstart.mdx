---
title: "Panduan Cepat"
description: "Mulai dengan LemonData API dalam 2 menit"
---
...
<Steps>
  ...
  <Step title="Tambah kredit">
    Buka dashboard dan tambahkan kredit ke akun Anda. LemonData menggunakan model bayar sesuai pemakaian tanpa komitmen minimum.
  </Step>
  <Step title="Buat API key">
    Buka **Dashboard → API Keys** dan buat kunci baru. Salin dengan aman karena hanya ditampilkan sekali.
  </Step>
</Steps>
...
LemonData mendukung ratusan model. Ubah hanya field `model`:
