...
LemonData menyediakan beberapa format API sehingga alat pengkodean umum, SDK, dan framework dapat berintegrasi dengan sedikit kode penghubung.
...
|-----------------|--------|------------------|--------|
| **OpenAI SDK** | Python/JS/Go | Jalur inti yang didukung | Chat Completions dan Embeddings adalah jalur yang didokumentasikan secara default; beberapa field yang hanya ada di Responses tidak dijamin berlaku pada setiap model dan jalur yang dirutekan |
