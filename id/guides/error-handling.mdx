...
| Tipe | Kode | Deskripsi |
|------|------|-------------|
| `insufficient_balance` | `insufficient_balance` | Saldo akun tidak mencukupi (endpoint kompatibel OpenAI) |
| `insufficient_balance_error` | `insufficient_balance` | Saldo akun tidak mencukupi (endpoint kompatibel Anthropic) |
