...
LemonData mengarahkan setiap model melalui format API native-nya untuk kompatibilitas terbaik:

| Keluarga Model | Format API | Base URL |
|----------------|------------|----------|
...
Artinya Claude Code berbicara dalam format native Anthropic, Gemini CLI berbicara dalam format native Gemini — tanpa overhead translasi format.
