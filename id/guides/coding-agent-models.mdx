...
## Cara Kerja Routing TokenLab

TokenLab secara otomatis mengarahkan permintaan Anda ke provider terbaik yang tersedia.
...
Jika provider tidak tersedia atau mengembalikan error, TokenLab secara otomatis mencoba ulang dengan provider berikutnya:
...
Ketika model yang dipilih dan kanal perutean mendukungnya, TokenLab dapat merutekan permintaan melalui format API native keluarga model untuk kompatibilitas yang lebih baik:
