...
Ketika model yang dipilih dan kanal perutean mendukungnya, LemonData dapat merutekan permintaan melalui format API native keluarga model untuk kompatibilitas yang lebih baik:

| Keluarga Model | Format API | URL Dasar |
|-------------|------------|----------|
| Claude | Anthropic Messages | `https://api.lemondata.cc` |
| GPT | Respons OpenAI | `https://api.lemondata.cc/v1` |
| Gemini | Gemini Native API | `https://api.lemondata.cc` atau `https://api.lemondata.cc/v1beta` tergantung jalur klien |
| DeepSeek | Obrolan OpenAI | `https://api.lemondata.cc/v1` |
