...
[Semantic cache](/id/guides/caching) LemonData mencocokkan permintaan berdasarkan makna, bukan teks yang persis sama. Ini sangat powerful untuk coding agents karena:
...
[Prompt caching upstream](/id/guides/prompt-cache) berjalan otomatis melalui LemonData. System prompt panjang — yang selalu disertakan coding agents — di-cache di level provider:

| Provider | Diskon Cache | Min Token |
|----------|-------------|-----------|
...
<AccordionGroup>
  ...
  <Accordion title="Cursor">
    Settings → Models → OpenAI API Key: `sk-your-key`, Base URL: `https://api.lemondata.cc/v1`
