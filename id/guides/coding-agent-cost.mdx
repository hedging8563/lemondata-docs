...
[Semantic cache](/id/guides/caching) TokenLab mencocokkan permintaan berdasarkan makna, bukan teks yang persis sama. Ini sangat powerful untuk coding agents karena:
...
[Prompt caching upstream](/id/guides/prompt-cache) berjalan otomatis melalui TokenLab. System prompt panjang — yang selalu disertakan coding agents — di-cache di level provider:
