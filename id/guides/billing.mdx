...
<Note>
  Harga yang ditampilkan adalah harga platform yang didiskon. Harga aktual dapat bervariasi. Periksa [halaman harga](https://tokenlab.sh/id/pricing) untuk tarif saat ini.
</Note>
