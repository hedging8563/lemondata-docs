...
1. Kirim tugas. LemonData dapat menerapkan pre-deduction atau reservasi estimasi untuk memeriksa saldo dan batas pengeluaran API Key.
...
Jika dashboard tidak menunjukkan settlement atau refund setelah status terminal terlihat, hubungi support@lemondata.cc untuk bantuan.
