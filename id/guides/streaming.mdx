...
Streaming memungkinkan Anda menerima output parsial saat output tersebut dihasilkan, yang meningkatkan latensi yang dirasakan dan pengalaman pengguna.

Untuk integrasi baru bergaya OpenAI, utamakan **Responses streaming** terlebih dahulu. Jika framework Anda masih menggunakan Chat Completions streaming, LemonData juga mendukung jalur kompatibilitas tersebut.
