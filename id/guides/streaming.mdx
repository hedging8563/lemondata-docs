...
Untuk integrasi baru bergaya OpenAI, utamakan **Responses streaming** terlebih dahulu. Jika framework Anda masih menggunakan Chat Completions streaming, TokenLab juga mendukung jalur kompatibilitas tersebut.
