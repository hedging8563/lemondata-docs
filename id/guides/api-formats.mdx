...
Jika LemonData tidak dapat merutekan request dengan tool native ke upstream yang mendukung format native, LemonData mengembalikan error unsupported-field yang eksplisit, bukan menghapus tool secara diam-diam atau berpura-pura tool itu adalah fungsi Chat Completions. Function tool buatan pengguna tetap menjadi jalur tool yang paling portabel.
