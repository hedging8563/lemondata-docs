...
| **Partner** | 3,000 | Untuk partner integrasi |
| **VIP** | 10,000 | Pengguna dengan volume tinggi |

<Note>
  Batas rate dapat berubah. Hubungi support@lemondata.cc untuk batas kustom.
</Note>
...
<AccordionGroup>
  ...
  <Accordion title="Hubungi kami untuk batas yang lebih tinggi">
    Jika Anda memerlukan batas yang lebih tinggi, hubungi support@lemondata.cc.
  </Accordion>
</AccordionGroup>
