...
Selain [platform semantic cache](/guides/caching) TokenLab, banyak penyedia AI menawarkan fitur **prompt caching** mereka sendiri. Ini adalah mekanisme caching terpisah yang beroperasi pada tingkat penyedia (Anthropic, OpenAI, DeepSeek, dll.).
...
|------|-------|--------------|------|
| **Platform Cache** | TokenLab | Pencocokan kemiripan semantik | 10% dari harga normal |
...
<Info>
Diskon diterapkan secara otomatis. TokenLab meneruskan harga cache penyedia kepada Anda.
</Info>
...
## Cache Platform vs Cache Penyedia
