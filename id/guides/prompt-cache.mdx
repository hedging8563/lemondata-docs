...
|------|-------|--------------|------|
| **Platform Cache** | LemonData | Pencocokan kemiripan semantik | Gratis (tanpa panggilan API) |
...
|----------|---------------------|------------------|------------|
| **Anthropic** | Diskon 90% | Sama dengan input | 1024 |
...
- **Cache** (biru langit): Platform semantic cache hit - biaya nol
...
Tulis cache: 2,000 tokens × $3.00/1M = $0.0060
Total: $0.0084 (penghematan 72%)
```
...
| **Biaya** | Gratis (tanpa panggilan API) | Tarif diskon |
