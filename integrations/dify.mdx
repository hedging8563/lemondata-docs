---
title: "Dify"
description: "Integrate LemonData with Dify using the OpenAI provider and a custom base URL"
---

## Overview

Dify works well with LemonData through its OpenAI-compatible model provider flow.
...
2. Open [API Keys](https://lemondata.cc/dashboard/api)
...
<Steps>
  ...
  <Step title="Enter LemonData Settings">
    Use these values:
