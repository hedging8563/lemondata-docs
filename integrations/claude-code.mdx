...
<Note>
For LemonData, keep `ANTHROPIC_BASE_URL` at `https://api.tokenlab.sh` without a `/v1` suffix. This matches the Anthropic-style endpoint shape and the unified gateway pattern documented by Claude Code.
</Note>
