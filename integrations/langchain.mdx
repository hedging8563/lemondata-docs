...
<Note>
  The agent APIs in LangChain are evolving. For new projects, consider using [LangGraph](https://python.langchain.com/docs/langgraph) for more flexible agent architectures.
</Note>
