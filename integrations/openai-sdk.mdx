---
title: "OpenAI SDK"
description: "Use LemonData with official OpenAI SDKs and OpenAI-compatible clients"
---

## Overview

LemonData works with the official OpenAI SDKs by pointing the client to `https://api.lemondata.cc/v1`.
...
**Primary Path**: OpenAI-compatible / OpenAI Responses
