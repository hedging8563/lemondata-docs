---
title: "LlamaIndex"
description: "Integrate LemonData with LlamaIndex using OpenAI-compatible integrations"
---

## Overview

For LemonData, the more robust LlamaIndex setup is to use **OpenAI-compatible integrations** instead of the built-in OpenAI classes.
...
<AccordionGroup>
  <Accordion title="Use OpenAILike for LemonData">
