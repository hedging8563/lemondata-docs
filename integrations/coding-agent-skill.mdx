...
description: "Install the maintained TokenLab API integration skill and teach coding agents to discover models, read public contracts, and recover from API errors."
---
...
If you installed the skill before the TokenLab repository cleanup, rerun the same command. The current public package is smaller and no longer depends on generated local search scripts.
