...
Treat these headers as routing hints, not a forced automatic switch. Claude-native calls use `/v1/messages`; Gemini-native calls should follow the endpoint advertised by `X-TokenLab-Native-Endpoint`, commonly `/v1beta/gemini`.
