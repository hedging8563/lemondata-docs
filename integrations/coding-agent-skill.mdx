---
title: "✨ LemonData API Integration Skill"
description: "Install the shared LemonData API integration skill for any coding agent, with Agent-First error recovery."
---

<Note>
This skill teaches your coding agent how to integrate LemonData's **hundreds of AI APIs** just by describing what you need. It is packaged as one shared agent-first skill and works with any coding agent that supports skill or rules files.
