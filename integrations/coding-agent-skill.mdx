...
<AccordionGroup>
  ...
  <Accordion title="Which coding agents are supported?">
    Any tool that supports skill/rules files: Claude Code, Cursor, GitHub Copilot, Windsurf, and more. The `npx skills add` installer auto-detects and installs to all supported tools.
  </Accordion>
