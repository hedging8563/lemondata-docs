...
<ParamField body="tools" type="array">
  ...
  Varsayılan görüntü aracı modelini kullanan veya açıkça `model: "gpt-image-2"` ayarlayan hosted `image_generation` araçlarında LemonData, isteği iletmeden önce desteklenmeyen `input_fidelity` alanını kaldırır; çünkü GPT Image 2 görüntü girdilerini zaten yüksek sadakatle işler. Bu araç için `background: "transparent"` göndermeyin; LemonData bunu sessizce kaldırmaz, çünkü çıktı semantiği değişir.
</ParamField>
