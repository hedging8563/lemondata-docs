...
Model hem özne görseli hem de hareket referans videosu bekliyorsa `operation=motion-control` kullanın. TokenLab herkese açık `image_url` + `video_url` biçimini uygun upstream sözleşmesine dönüştürür.
