...
| `model` | string | max uzunluk `100` | İstenen model adı |
...
- `accessChannel=platform`, isteğin TokenLab'nın platform kanalından faturalandığı anlamına gelir.
- `accessChannel=byok`, isteğin kendi provider anahtarınızı kullandığı anlamına gelir.
