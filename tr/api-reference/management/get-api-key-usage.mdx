...
- Tüm parasal yanıt alanları USD olarak kalır ve artık `cost_cny`, `total_cost_cny` ile her breakdown içindeki `cost_cny` gibi RMB gösterim alanlarını da içerir.
