...
Görev artık mevcut değilse ya da artık genel async-task sözleşmesi üzerinden çözümlenemiyorsa, LemonData `async_task_not_found` döndürür ve `Task not found or no longer available.` iletisini verir.
</Info>
