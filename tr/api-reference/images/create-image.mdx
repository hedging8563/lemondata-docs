...
<ParamField body="size" type="string" default="1024x1024">
  ...
  `gpt-image-2` için `size`, OpenAI uyumlu upstream yoluna iletilir ve modelin şu anda kabul ettiği herhangi bir geçerli değeri kullanabilir. `aspect_ratio` ve `resolution`, LemonData’nın `gpt-image-2` için mevcut genel sözleşmesine dahil değildir.
