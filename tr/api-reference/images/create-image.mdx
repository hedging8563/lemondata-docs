...
<ParamField body="model" type="string" required>
  Kullanılacak model (ör. `gpt-image-2`, `flux-pro`, `qwen-image` veya `nano-banana-pro`). Güncel önerilen liste için `GET /v1/models?recommended_for=image` kullanın.
</ParamField>
...
| `qwen-image` | Sıklıkla task tabanlı | Güçlü metin oluşturma ve prompt takibi |
