...
<ParamField body="resolution" type="string">
  ...
  `gemini-3-pro-image-preview`, `nano-banana-pro`, `nano-banana-2` ve benzeri yüksek çözünürlüklü ailelerde desteklenir. Tipik değerler `1k`, `2k` ve `4k`'tür. Model bunu açıkça belgelemiyorsa bu parametreyi Gemini Flash image ailelerine göndermeyin. xAI Grok Imagine görsel modelleri için `1k` veya `2k` kullanın.
</ParamField>
