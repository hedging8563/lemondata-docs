...
Uyumluluk notu: Bir `gpt-image-2` isteği `input_fidelity` gönderirse TokenLab bu alanı kaldırır; çünkü GPT Image 2 görüntü girdilerini zaten otomatik olarak yüksek doğrulukta işler.
</Note>
