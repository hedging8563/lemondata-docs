...
Bu uç nokta, TokenLab'nın OpenAI uyumlu Batch API'sinin bir parçasıdır. Batch işleri, yüklenen JSONL dosyalarını kullanır, asenkron olarak çalışır ve daha sonra çıktı/hata dosyaları döndürebilir.
