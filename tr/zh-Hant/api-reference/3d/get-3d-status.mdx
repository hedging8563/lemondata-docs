...
description: "3D oluşturma görevinin durumunu ve sonucunu alın"
---

3D model oluşturma görevinizin durumunu kontrol etmek için bu uç noktayı yoklayın (poll).

## Yol Parametreleri

<ParamField path="id" type="string" required>
  3D oluşturma görev ID'si.
</ParamField>
