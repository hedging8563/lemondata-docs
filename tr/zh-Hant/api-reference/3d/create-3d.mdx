...
description: "Bir 3D model oluşturma görevi başlatın"
---
...
<ParamField body="image_url" type="string">
  Görselden 3D'ye üretim için görsel URL'si.
</ParamField>
...
<ParamField body="seed" type="integer">
  Tekrarlanabilir üretim için kullanılan seed değeri.
</ParamField>
...
<ResponseField name="id" type="string">
  Durum sorgulama için kullanılan görev ID'si.
</ResponseField>
