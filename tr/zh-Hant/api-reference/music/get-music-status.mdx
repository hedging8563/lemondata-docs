...
description: "Müzik oluşturma görevinin durumunu ve sonucunu alın"
---

Müzik oluşturma görevinin durumunu kontrol etmek için bu uç noktayı yoklayın (poll).
...
<ResponseField name="audio_url" type="string">
  Ses dosyası indirme bağlantısı (tamamlandığında).
</ResponseField>

<ResponseField name="video_url" type="string">
  Görselleştirme efektli video sürümü bağlantısı (tamamlandığında).
</ResponseField>
