...
description: "Video oluşturma görevi oluşturun"
---

## Genel Bakış

Video oluşturma asenkrondur. Bir istek gönderirsiniz ve bir `task_id` alırsınız, ardından sonucu sorgularsınız (polling).
...
<ParamField body="negative_prompt" type="string">
  Video oluşturma sırasında kaçınılması gereken içerik.
</ParamField>

<ParamField body="seed" type="integer">
  Tekrarlanabilir üretim için kullanılan rastgele tohum (seed).
</ParamField>

<ParamField body="cfg_scale" type="number">
  Sınıflandırıcısız rehberlik ölçeği (0-20).
</ParamField>
...
<ParamField body="user" type="string">
  Son kullanıcının benzersiz tanımlayıcısı.
</ParamField>

## Yanıt

<ResponseField name="task_id" type="string">
  Sorgulama (polling) için kullanılan benzersiz görev tanımlayıcısı.
</ResponseField>
...
| Model | Tür | Açıklama |
|-------|------|-------------|
| `kling-video` | T2V/I2V | Gerçekçi hareketler, birden fazla sürüm (v1.0-v2.6) |
| `veo3.1` | T2V | Google'ın en yeni modeli |
| `veo3.1-pro` | T2V | Profesyonel düzeyde kalite |
| `minimax/video-01` | T2V | Yüksek tempo ve kararlılık |
