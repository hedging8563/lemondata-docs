...
description: "Video oluşturma görevinin durumunu ve sonucunu alın"
---

## Yol Parametreleri

<ParamField path="task_id" type="string" required>
  Video oluşturma isteğinden döndürülen görev ID'si.
</ParamField>
...
<ResponseField name="video_url" type="string">
  Oluşturulan video URL'si (tamamlandığında).
</ResponseField>
...
- Her 5-10 saniyede bir polling yapın
- Daha uzun süren görevler için üstel geri çekilme (exponential backoff) uygulayın
- Maksimum zaman aşımı süresi belirleyin (örneğin 10 dakika)
