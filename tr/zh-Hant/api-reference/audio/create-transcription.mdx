...
<ParamField body="language" type="string">
  Sesin dili, ISO-639-1 formatında (örneğin: `en`, `zh`, `ja`).
</ParamField>

<ParamField body="prompt" type="string">
  Modelin stilini yönlendirmek veya önceki bölümleri devam ettirmek için kullanılan isteğe bağlı metin.
</ParamField>
...
<ParamField body="timestamp_granularities" type="array">
  Zaman damgası hassasiyeti: `word` ve/veya `segment`. `verbose_json` gerektirir.
</ParamField>
...
<ResponseField name="segments" type="array">
  Zaman damgalarını içeren transkripsiyon bölümleri.
</ResponseField>

<ResponseField name="words" type="array">
  Kelime düzeyinde zaman damgaları (eğer istenirse).
</ResponseField>
...
Sesi İngilizceye çevirmek için çeviri uç noktasını kullanın:
