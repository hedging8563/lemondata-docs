---
title: "İçerik Oluşturmayı Akışla"
openapi: "POST /v1beta/models/{model}:streamGenerateContent"
description: "Google Gemini API formatını kullanarak içerik oluşturmayı akışla gerçekleştirin"
---
...
<ParamField query="key" type="string">
  API anahtarı (header doğrulamasının alternatifi).
</ParamField>
...
Her biri kısmi bir yanıt içeren bir JSON nesne akışı döndürür.
