...
Kamu rotaları (public routes) yanıt gövdesinde yazım hatası, gizli, ertelenmiş veya genel olmayan model durumlarını ayırt etmez. Bir model şu anda genel sözleşme aracılığıyla kullanılamıyorsa, LemonData `model_not_found` döner.
