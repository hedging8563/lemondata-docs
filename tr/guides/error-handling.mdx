...
| Tür | Kod | Açıklama |
|------|------|-------------|
| `insufficient_balance` | `insufficient_balance` | Hesap bakiyesi yetersiz (OpenAI uyumlu uç noktalar) |
| `insufficient_balance_error` | `insufficient_balance` | Hesap bakiyesi yetersiz (Anthropic uyumlu uç noktalar) |
