...
LemonData'nın [semantik önbelleği](/tr/guides/caching) istekleri anlam bazında eşleştirir:
...
[Upstream Prompt Cache](/tr/guides/prompt-cache) otomatik olarak çalışır:
