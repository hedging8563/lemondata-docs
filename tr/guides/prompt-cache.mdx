...
TokenLab'nın [platform semantik önbelleğine](/guides/caching) ek olarak, birçok AI sağlayıcısı kendi **prompt önbelleğe alma** özelliğini sunar. Bu, sağlayıcı seviyesinde (Anthropic, OpenAI, DeepSeek vb.) çalışan ayrı bir önbellekleme mekanizmasıdır.
...
|------|-------|--------------|------|
| **Platform Önbelleği** | TokenLab | Semantik benzerlik eşleşmesi | Normal fiyatın %10'u |
...
<Info>
İndirimler otomatik olarak uygulanır. TokenLab, sağlayıcının önbellek fiyatlandırmasını size olduğu gibi yansıtır.
</Info>
