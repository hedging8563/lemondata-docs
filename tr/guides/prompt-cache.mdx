...
|------|-------|--------------|------|
| **Platform Önbelleği** | LemonData | Semantik benzerlik eşleşmesi | Ücretsiz (API çağrısı yapılmaz) |
...
- **Cache** (gök mavisi): Platform semantik önbellek isabeti - sıfır maliyet
...
| **Maliyet** | Ücretsiz (API çağrısı yok) | İndirimli ücretler |
