...
TokenLab, API maliyetlerinizi ve yanıt gecikmenizi önemli ölçüde azaltabilen akıllı bir önbellekleme sistemi sunar. Önbelleklememiz basit istek eşleştirmenin ötesine geçer - istemlerinizin (prompts) **semantik anlamını** anlar.
...
TokenLab iki katmanlı bir önbellekleme sistemi kullanır:
...
- **Aşama 2 (Tam bağlam)**: Konuşma bağlamı dahil ≥%95 benzerlik
