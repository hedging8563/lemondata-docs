...
| **İş Ortağı** | 3,000 | Entegrasyon iş ortakları için |
| **VIP** | 10,000 | Yüksek hacimli kullanıcılar için |

<Note>
  Rate limitleri değişikliğe tabidir. Özel limitler için support@lemondata.cc ile iletişime geçin.
</Note>
...
1. [Dashboard](https://lemondata.cc/dashboard) hesabınıza giriş yapın
2. **Settings → Account** bölümüne gidin
3. Kullanım senaryonuzla birlikte support ekibiyle iletişime geçin

Veya support@lemondata.cc adresine şu bilgilerle e-posta gönderin:
