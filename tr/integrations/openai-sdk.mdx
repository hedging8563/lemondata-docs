---
title: "OpenAI SDK"
description: "LemonData'ı resmi OpenAI SDK'ları ve OpenAI-uyumlu istemcilerle kullanın"
---

## Genel Bakış

LemonData, istemciyi `https://api.lemondata.cc/v1` adresine yönlendirerek resmi OpenAI SDK'ları ile çalışır.
