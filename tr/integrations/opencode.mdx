---
title: "OpenCode"
description: "LemonData API kullanacak şekilde OpenCode'u yapılandırın"
---
...
OpenCode, terminalinizde çalışan açık kaynaklı bir AI kodlama asistanıdır. Birden fazla LLM sağlayıcısını destekler ve yüzlerce modele erişim için LemonData API'sini kullanacak şekilde yapılandırılabilir.
...
<AccordionGroup>
  ...
  <Accordion title="Model Bulunamadı">
    ...
    - Modelin kullanılabilirliğini [lemondata.cc/en/models](https://lemondata.cc/tr/models) adresinde doğrulayın
  </Accordion>
</AccordionGroup>
