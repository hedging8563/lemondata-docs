...
<Warning>
Bu entegrasyonu deneysel kabul edin: Gemini CLI şu anda LemonData benzeri özel Base URL iş akışını kararlı bir resmi yapılandırma olarak belgelemiyor. Desteklenen bir LemonData terminal kurulumu istiyorsanız Codex CLI, Claude Code veya OpenCode kullanın.
</Warning>
