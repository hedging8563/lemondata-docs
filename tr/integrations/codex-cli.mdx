---
title: "Codex CLI"
description: "OpenAI Codex CLI'yi LemonData API ile kullanmak için yapılandırın"
---
...
LemonData için, Codex CLI `/v1/responses` kullanabilir, ancak bunu gelişmiş bir uyumluluk yolu olarak ele almalısınız. Sadece Responses özelliklerinin her model ve yönlendirilen yol boyunca garantili olmadığı durumlar vardır.
...
<AccordionGroup>
  ...
  <Accordion title="Model Bulunamadı">
    ...
    - Model kullanılabilirliğini şu adreste doğrulayın: [lemondata.cc/en/models](https://lemondata.cc/tr/models)
  </Accordion>
