---
title: "Vercel AI SDK"
description: "TokenLab'yı OpenAI ile uyumlu veya Responses native sağlayıcılar kullanarak Vercel AI SDK ile entegre edin"
---
...
TokenLab için Vercel AI SDK'deki en kararlı varsayılan seçenek **OpenAI ile uyumlu sağlayıcı**dır.

Özellikle **Responses native** davranışına ihtiyacınız varsa, OpenAI sağlayıcısına geçebilir ve aynı TokenLab temel URL'sini kullanmaya devam edebilirsiniz.
