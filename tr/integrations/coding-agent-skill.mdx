...
<AccordionGroup>
  ...
  <Accordion title="Hangi kodlama asistanları destekleniyor?">
    Yetenek/kural dosyalarını destekleyen tüm araçlar: Claude Code, Cursor, GitHub Copilot, Windsurf ve daha fazlası. `npx skills add` yükleyicisi otomatik olarak tespit eder ve desteklenen tüm araçlara kurulum yapar.
  </Accordion>
